            ...
            if (
              ...
              if (this.dynamicAnim) {
                ...
                for (var S = 0; S < h.globals.collapsedSeries.length; S++)
                  h.globals.collapsedSeries[S].index === s &&
                    ((A = 1), (a = 0));
                0 === t && 0 === e && (a = 0),
                  d.animateCircle(
                    m,
        ...
        },
        {
          ...
          value: function () {
            ...
            o.globals.axisCharts ||
              (o.globals.previousPaths = o.globals.series);
          },
        },
        {
            ...
            if (
              ...
              for (var d = 0; d < c + (this.isTimelineBar ? 1 : 0); d++)
                this._drawGridLine({
                  ...
                  (r = s +=
                    h.globals.gridHeight / (this.isTimelineBar ? c : a));
            }
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t, s, r, e) {
            ...
            var h = a.map(function (t, e) {
              ...
              return (
                Math.round(a / I.roundToBase(a, 10)) * I.roundToBase(a, 10)
              );
            });
            return (
              0 === h[0] && (h[0] = 1),
            ...
            for (
              ...
              if (0 < e.globals.ancillaryCollapsedSeriesIndices.length)
                for (
                  ...
                  e.globals.ancillaryCollapsedSeriesIndices[g] === o &&
                    (c = !0);
            ...
            value: function (t) {
              ...
              r.config.yaxis.forEach(function (t, e) {
                b.push(
                  ...
                  m.push(
                    r.globals.yAxisScale[e].niceMax - o.yRatio[e] * n.endY
                  );
              }),
                n.dragged &&
