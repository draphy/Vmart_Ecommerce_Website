  ...
  function r(e) {
    for (
      ...
      !(function (e) {
        var t, o, i, n, s, l;
        null !== (e = r[c]) &&
          (p.contains(document.documentElement, e.ele[0]) || (r[c] = e = null)),
          null !== e &&
            ...
            o <= t
              ? (!(i = {
                ...
                e.footerElement.length &&
                  ...
                  (s = e.ele.outerHeight()),
                  (l = i.top + s + e.bottomOffset + e.topOffset),
                  !1 === e.isWindow
                    ? (l = s + e.bottomOffset + e.topOffset)
                    : ((l = i.top + t + s + e.bottomOffset),
                      (n = e.getElementDistanceFromViewport(e.footerElement))),
                  n < l &&
                    (!0 === e.isWindow
                      ? (i.top = n - (t + s + e.bottomOffset))
                      : (i.top = t - (l - n)))),
                !0 === e.setParentOnStick &&
                  e.eleParent.css("height", e.eleParent.height()),
                !0 === e.setWidthOnStick &&
                  e.ele.css("width", e.ele.css("width")),
                e.isViewportOffsetParent ||
                  (i.top =
                    i.top -
                    e.getElementDistanceFromViewport(e.eleOffsetParent)),
                f && !1 === e.isWindow
                  ? e.ele
              ...
              : t <= o &&
                e.isStick &&
                (e.ele.css({ position: "", top: "" }).removeClass(e.stickClass),
                !(e.isStick = !1) === e.setParentOnStick &&
                  e.eleParent.css("height", ""),
                !0 === e.setWidthOnStick && e.ele.css("width", ""),
                (e.wasStickCalled = !1),
                setTimeout(function () {
    ...
    return this.each(function () {
      ...
      function n() {
        i.setEleTop(),
          ...
          i.isWindow ||
            (i.isViewportOffsetParent = i.eleOffsetParent[0] === i.viewport[0]),
          e ||
            ((e = "stickOnScroll" + String(Math.random()).replace(/\D/g, "")),
      ...
      return (
        ...
        (i.eleTop = 0),
        (i.eleTopMargin = parseFloat(i.ele.css("margin-top") || 0) || 0),
        ...
        (i.setEleTop = function () {
          !1 === i.isStick &&
            (i.isWindow
              ...
              : (i.eleTop = i.ele.offset().top - i.viewport.offset().top));
        }),
        ...
        i.ele.is(":visible")
          ...
          : (t = setInterval(function () {
              (!i.ele.is(":visible") && o) || (clearInterval(t), n()), --o;
            }, 100)),
        this
      );
    });
