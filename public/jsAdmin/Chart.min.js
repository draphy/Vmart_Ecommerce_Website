!(function (t, e) {
      ...
      ((function (t) {
        ...
        for (var n in o)
          if (o.hasOwnProperty(n)) {
            ...
            delete o[n].channels,
              delete o[n].labels,
              Object.defineProperty(o[n], "channels", { value: i }),
              Object.defineProperty(o[n], "labels", { value: a });
          }
        (o.rgb.hsl = function (t) {
          ...
          (o.lab.xyz = function (t) {
            ...
            var r = Math.pow(n, 3),
              ...
              s = Math.pow(i, 3);
            return (
              (n = 0.008856 < r ? r : (n - 16 / 116) / 7.787),
              (e = 0.008856 < o ? o : (e - 16 / 116) / 7.787),
              (i = 0.008856 < s ? s : (i - 16 / 116) / 7.787),
  ...
  function l(t, e) {
    for (
      var n = [e[t].parent, t], i = d[e[t].parent][t], a = e[t].parent;
      e[a].parent;
  ...
  Object.keys(d).forEach(function (o) {
    (h[o] = {}),
      Object.defineProperty(h[o], "channels", { value: d[o].channels }),
      Object.defineProperty(h[o], "labels", { value: d[o].labels });
    var s = (function () {
      for (
        var t = (function (t) {
            var e = (function () {
                for (
                  var t = {}, e = Object.keys(d), n = e.length, i = 0;
                  i < n;
                  i++
                )
            ...
            for (e[t].distance = 0; n.length; )
              for (
                var i = n.pop(), a = Object.keys(d[i]), r = a.length, o = 0;
                o < r;
                o++
              ) {
                var s = a[o],
    ...
    Object.keys(s).forEach(function (t) {
      ...
      (h[o][t] = ("conversion" in (a = n) && (r.conversion = a.conversion), r)),
        (h[o][t].raw =
          ("conversion" in (e = n) && (i.conversion = e.conversion), i));
    });
  });
  var c = h,
    o = {
  ...
  (x.prototype = {
    ...
    luminosity: function () {
      for (var t = this.values.rgb, e = [], n = 0; n < t.length; n++) {
        var i = t[n] / 255;
        e[n] = i <= 0.03928 ? i / 12.92 : Math.pow((0.055 + i) / 1.055, 2.4);
      }
    ...
    (x.prototype.setValues = function (t, e) {
      ...
      if (
        ((i.alpha = Math.max(0, Math.min(1, void 0 === o ? i.alpha : o))),
        "alpha" === t)
      )
        return !1;
    ...
    F = {
          ...
          ? ((s = e + (o = Math.min(r, a / 2, i / 2))),
            ...
            s < d && l < u
              ...
              ? (t.moveTo(s, n),
                ...
                t.arc(s, l, o, D, C + D))
              : l < u
              ? (t.arc(s, l, o, -C, 0), t.arc(s, u, o, 0, C))
              : t.arc(s, l, o, -C, C),
            t.closePath(),
            t.moveTo(e, n))
          : t.rect(e, n, i, a);
      ...
      lineTo: function (t, e, n, i) {
        ...
        r
          ? ("middle" === r
              ? ((a = (e.x + n.x) / 2),
                t.lineTo(a, i ? n.y : e.y),
                t.lineTo(a, i ? e.y : n.y))
              : ("after" === r && !i) || ("after" !== r && i)
              ? t.lineTo(e.x, n.y)
              : t.lineTo(n.x, e.y),
            t.lineTo(n.x, n.y))
      ...
      _parseFont: function (t) {
        var e,
          ...
          a = {
            ...
            lineHeight: w.options.toLineHeight(
              R(t.lineHeight, n.defaultLineHeight),
              i
            ),
            size: i,
        ...
        return (
          (a.string =
            !(e = a) || w.isNullOrUndef(e.size) || w.isNullOrUndef(e.family)
              ? null
              : (e.style ? e.style + " " : "") +
                (e.weight ? e.weight + " " : "") +
                e.size +
      ...
      resolve: function (t, e, n, i) {
        for (var a, r = !0, o = 0, s = t.length; o < s; ++o)
          if (
            ...
            void 0 !== n && w.isArray(a) && ((a = a[n]), (r = !1)),
            void 0 !== a)
          )
    ...
    transition: function (t) {
      ...
      return (
        n && 1 !== t
          ...
          : ((e._view = W.extend({}, n)), (e._start = null)),
        e
      );
    },
  ...
  var K = {
      ...
      requestAnimationFrame: function () {
        var t = this;
        null === t.request &&
          (t.request = W.requestAnimFrame.call(window, function () {
      ...
      advance: function () {
        for (var t, e, n, i, a = this.animations, r = 0; r < a.length; )
          (e = (t = a[r]).chart),
            ...
            t.currentStep >= n
              ? (W.callback(t.onAnimationComplete, [t], e),
                (e.animating = !1),
                a.splice(r, 1))
              : ++r;
      },
  ...
  function J(e, t) {
    var n,
      ...
      a = e._chartjs;
    a &&
      (-1 !== (i = (n = a.listeners).indexOf(t)) && n.splice(i, 1),
      0 < n.length ||
        ($.forEach(function (t) {
          delete e[t];
        }),
                ...
                Object.defineProperty(a, t, {
                  ...
                  value: function () {
                    var e = Array.prototype.slice.call(arguments),
                      t = i.apply(this, e);
                    return (
                      W.each(a._chartjs.listeners, function (t) {
    ...
    getStyle: function (t) {
      ...
      return (
        ...
        (!1 !==
          (e =
            i && void 0 === t
              ? this._resolveDatasetElementOptions(i || {})
              : ((t = t || 0),
                this._resolveDataElementOptions(n.data[t] || {}, t))).fill &&
          null !== e.fill) ||
    ...
    _resolveDatasetElementOptions: function (t, e) {
      for (
        var n,
          ...
          o = a._config,
          s = t.custom || {},
          l = r.options.elements[a.datasetElementType.prototype._type] || {},
  ...
  var it = Y.extend({
      ...
      inRange: function (t, e) {
        ...
        if (n) {
          for (
            var i = W.getAngleFromPoint(n, { x: t, y: e }),
              a = i.angle,
              r = i.distance,
              o = n.startAngle,
              s = n.endAngle;
          ...
          o.borderWidth &&
            ...
            i.fullCircles &&
              (function (t, e, n) {
                ...
                for (
                  r &&
                    ((n.endAngle = n.startAngle + et),
                    nt(t, n),
                    (n.endAngle = a),
                    n.endAngle === n.startAngle &&
                      n.fullCircles &&
                      ((n.endAngle += et), n.fullCircles--)),
                    t.beginPath(),
                    t.arc(
                      n.x,
                      n.y,
            ...
            r && nt(e, i),
            e.beginPath(),
            e.arc(i.x, i.y, n.outerRadius, i.startAngle, i.endAngle),
        ...
        if (s.length) {
          if (i._loop) {
            for (t = 0; t < s.length; ++t)
              if (
                ((e = W.previousItem(s, t)), !s[t]._view.skip && e._view.skip)
              ) {
          ...
          for (
            r.save(),
              r.lineCap = a.borderCapStyle || d.borderCapStyle,
              r.setLineDash && r.setLineDash(a.borderDash || d.borderDash),
              r.lineDashOffset = at(a.borderDashOffset, d.borderDashOffset),
              r.lineJoin = a.borderJoinStyle || d.borderJoinStyle,
              r.lineWidth = at(a.borderWidth, d.borderWidth),
              r.strokeStyle = a.borderColor || l.defaultColor,
              r.beginPath(),
              (n = s[0]._view).skip || (r.moveTo(n.x, n.y), (u = 0)),
              t = 1;
            t < s.length;
            ++t
          )
  ...
  var ut = Y.extend({
      ...
      draw: function (t) {
        var e = this._view,
          ...
          d = l.defaultColor;
        e.skip ||
          (void 0 !== t && !W.canvas._isPointInArea(e, t)) ||
          ((n.strokeStyle = e.borderColor || d),
          (n.lineWidth = st(e.borderWidth, l.elements.point.borderWidth)),
          (n.fillStyle = e.backgroundColor || d),
          W.canvas.drawPoint(n, i, r, o, s, a));
      },
    }),
      ...
      draw: function () {
        var t,
          ...
          b =
            ...
            l &&
              (e.horizontal
                ? e.base > e.x && (l = gt(l, "left", "right"))
                : e.base < e.y && (l = gt(l, "bottom", "top")),
              (d[l] = !0)),
            (h = d),
            W.isObject(u)
              ? ((a = +u.top || 0),
            ...
            {
              outer: { x: c.left, y: c.top, w: f, h: g },
              inner: {
                x: c.left + p.l,
                y: c.top + p.t,
                w: f - p.l - p.r,
  ...
  var wt = tt.extend({
      ...
      _getStacks: function (t) {
        for (
          var e,
            ...
            i = n._getMatchingVisibleMetas(this._type),
            a = n.options.stacked,
            r = i.length,
            o = [],
            s = 0;
      ...
      calculateBarValuePixels: function (t, e, n) {
        ...
        if (v || (void 0 === v && void 0 !== b))
          for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
            a.stack === b &&
              ((r =
                void 0 === (d = h._parseValue(f[a.index].data[e])).start
                  ? d.end
                  : 0 <= d.min && 0 <= d.max
                  ? d.max
                  : d.min),
              ((p.min < 0 && r < 0) || (0 <= p.max && 0 < r)) && (x += r));
        return (
          (o = h.getPixelForValue(x)),
          (l = (s = h.getPixelForValue(x + y)) - o),
          void 0 !== m &&
            Math.abs(l) < m &&
            ((l = m), (s = (0 <= y && !c) || (y < 0 && c) ? o - m : o + m)),
          ...
          _ =
            "flex" === i.barThickness
              ? ((g = i),
                ...
                (v = m[e]),
                (b = 0 < e ? m[e - 1] : null),
                (x = e < m.length - 1 ? m[e + 1] : null),
                (y = g.categoryPercentage),
                null === b && (b = v - (null === x ? f.end - f.start : x - v)),
                null === x && (x = v + v - b),
                (p = v - ((v - Math.min(b, x)) / 2) * y),
                {
              ...
              : ((a = e),
                ...
                (h = W.isNullOrUndef(l)
                  ? (function (t, e) {
                      for (
                        var n, i, a = t._length, r = 1, o = e.length;
                        r < o;
                        ++r
                      )
                  ...
                  : -1),
                (c = W.isNullOrUndef(l)
                  ? ((s = h * o.categoryPercentage), o.barPercentage)
                  : ((s = l * d), 1)),
                { chunk: s / d, ratio: c, start: u - s / 2 }),
      ...
      _resolveDataElementOptions: function () {
        var t = W.extend(
            {},
            tt.prototype._resolveDataElementOptions.apply(this, arguments)
          ),
          e = this._getIndexScale().options,
          n = this._getValueScale().options;
        return (
          (t.barPercentage = kt(e.barPercentage, t.barPercentage)),
          (t.barThickness = kt(e.barThickness, t.barThickness)),
          (t.categoryPercentage = kt(
            e.categoryPercentage,
            t.categoryPercentage
          )),
          (t.maxBarThickness = kt(e.maxBarThickness, t.maxBarThickness)),
  ...
  var Ct = tt.extend({
      ...
      updateElement: function (t, e, n) {
        var i = this,
          ...
          h = n
            ...
            : o.getPixelForValue("object" == typeof d ? d : NaN, e, u),
      ...
      _resolveDataElementOptions: function (t, e) {
        ...
        return (
          n._cachedDataOpts === s && (s = W.extend({}, s)),
          (s.radius = St(
    ...
    legend: {
      labels: {
        generateLabels: function (a) {
          var r = a.data;
          return r.labels.length && r.datasets.length
            ? r.labels.map(function (t, e) {
      ...
      onClick: function (t, e) {
        for (
          var n,
            ...
            a = this.chart,
            r = 0,
            o = (a.data.datasets || []).length;
          r < o;
          ++r
        )
          (n = a.getDatasetMeta(r)).data[i] &&
            (n.data[i].hidden = !n.data[i].hidden);
        a.update();
      },
    },
    cutoutPercentage: 50,
    ...
    update: function (t) {
      ...
      for (
        D < Dt &&
          ...
          (c = (r <= Tt && Tt <= o) || Dt + Tt <= o),
          (f = (r <= -Tt && -Tt <= o) || At + Tt <= o),
          (g = r === -At || At <= o ? -1 : Math.min(s, s * A, d, d * A)),
          (p = f ? -1 : Math.min(l, l * A, u, u * A)),
          (k = ((m = h ? 1 : Math.max(s, s * A, d, d * A)) - g) / 2),
          (w = ((v = c ? 1 : Math.max(l, l * A, u, u * A)) - p) / 2),
          (M = -(m + g) / 2),
          (S = -(v + p) / 2)),
          i = 0,
          a = P.length;
      ...
      for (
        x.borderWidth = b.getMaxBorderWidth(),
          e = (y.right - y.left - x.borderWidth) / k,
          n = (y.bottom - y.top - x.borderWidth) / w,
          x.outerRadius = Math.max(Math.min(e, n) / 2, 0),
          x.innerRadius = Math.max(x.outerRadius * A, 0),
          x.radiusLength =
            (x.outerRadius - x.innerRadius) /
            (b._getVisibleDatasetWeightTotal() || 1),
          x.offsetX = M * x.outerRadius,
          x.offsetY = S * x.outerRadius,
          C.total = b.calculateTotal(),
          b.outerRadius =
            x.outerRadius - x.radiusLength * b._getRingWeightOffset(b.index),
          b.innerRadius = Math.max(b.outerRadius - x.radiusLength * T, 0),
          i = 0,
          a = P.length;
        i < a;
        ++i
      ...
      var i = this,
        ...
        f =
          (n && s.animateRotate) || t.hidden
            ? 0
            : i.calculateCircumference(c.data[e]) * (o.circumference / Dt),
    ...
    getMaxBorderWidth: function (t) {
      ...
      for (e = 0, n = t.length; e < n; ++e)
        (a = t[e]),
          "inner" !==
            (o = r
              ? (r._configure(), r._resolveDataElementOptions(a, e))
              : a._options).borderAlign &&
            ((s = o.borderWidth),
            (d = (l = o.hoverBorderWidth) > (d = d < s ? s : d) ? l : d));
      return d;
    },
    setHoverStyle: function (t) {
      var e = t._model,
  ...
  var Nt = tt.extend({
      ...
      update: function (t) {
        ...
        for (
          d && 0 !== r._model.tension && i.updateBezierControlPoints(),
            e = 0,
            n = o.length;
          e < n;
          ++e
      ...
      _resolveDatasetElementOptions: function (t) {
        ...
        return (
          (v.spanGaps = Lt(f.spanGaps, p.spanGaps)),
          (v.tension = Lt(f.lineTension, m.tension)),
          (v.steppedLine = Ot([g.steppedLine, f.steppedLine, m.stepped])),
          (v.clip =
            ((e = Lt(
              f.clip,
              ((o = c._xScale),
      ...
      calculatePointY: function (t, e, n) {
        ...
        if (h.options.stacked) {
          for (
            s = +h.getRightValue(t),
              d = (l = u._getSortedVisibleDatasetMetas()).length,
              i = 0;
            i < d && (r = l[i]).index !== n;
            ++i
          )
      ...
      updateBezierControlPoints: function () {
        ...
        if (
          ...
          for (t = 0, e = l.length; t < e; ++t)
            (n = l[t]._model),
              (i = W.splineCurve(
                W.previousItem(l, t)._model,
                n,
                W.nextItem(l, t)._model,
                o.tension
              )),
          ...
          for (t = 0, e = l.length; t < e; ++t)
            (n = l[t]._model),
              Rt(n, s) &&
                (0 < t &&
                  Rt(l[t - 1]._model, s) &&
                  ((n.controlPointPreviousX = d(
                    n.controlPointPreviousX,
                    s.left,
                    s.right
                  )),
                  (n.controlPointPreviousY = d(
                ...
                t < l.length - 1 &&
                  Rt(l[t + 1]._model, s) &&
                  ((n.controlPointNextX = d(
                    n.controlPointNextX,
                    s.left,
                    s.right
                  )),
                  (n.controlPointNextY = d(
                    n.controlPointNextY,
                    s.top,
                    s.bottom
                  ))));
  ...
  var Et = tt.extend({
    ...
    update: function (t) {
      ...
      for (
        ...
        (l[e] = s), (i = a._computeAngle(e)), (s += d[e] = i);
  ...
  N._set("pie", W.clone(N.doughnut)), N._set("pie", { cutoutPercentage: 0 });
  var Wt = It,
    Vt = W.valueOrDefault;
  N._set("radar", {
    spanGaps: !1,
  ...
  var Ht = tt.extend({
    ...
    _resolveDatasetElementOptions: function () {
      ...
      return (
        (n.spanGaps = Vt(t.spanGaps, e.spanGaps)),
        (n.tension = Vt(t.lineTension, e.elements.line.tension)),
        n
      );
    },
    updateBezierControlPoints: function () {
      ...
      for (
        ...
        (n = o[t]._model),
          (i = W.splineCurve(
            W.previousItem(o, t, !0)._model,
            n,
            W.nextItem(o, t, !0)._model,
            n.tension
          )),
  ...
  function qt(t, e) {
    return t.native ? { x: t.x, y: t.y } : W.getRelativePosition(t, e);
  }
  function Ut(t, e) {
    for (
      var n,
        ...
        a,
        r,
        o = t._getSortedVisibleDatasetMetas(),
        s = 0,
        l = o.length;
      s < l;
      ++s
  ...
  function Gt(t, i, a, r) {
    ...
    return (
      Ut(t, function (t) {
        ...
        (a && !t.inRange(i.x, i.y)) ||
          ((e = t.getCenterPoint()),
          (n = r(i, e)) < o ? ((s = [t]), (o = n)) : n === o && s.push(t));
      }),
      s
    );
  }
  ...
  function ne(t, e, n) {
    for (
      var i, a, r, o, s, l, d, u, h, c, f, g, p = [], m = 0, v = t.length;
      m < v;
      ++m
    )
      (a = (i = t[m]).box).update(
        ...
        f.getPadding &&
          ((c = f.getPadding()),
          (g.top = Math.max(g.top, c.top)),
          (g.left = Math.max(g.left, c.left)),
          (g.bottom = Math.max(g.bottom, c.bottom)),
          (g.right = Math.max(g.right, c.right))),
        (u = l.outerWidth - te(g, s, "left", "right")),
        (h = l.outerHeight - te(g, s, "top", "bottom")),
        (u === s.w && h === s.h) ||
          ((s.w = u), (s.h = h), d.horizontal ? u === s.w : h === s.h) ||
          ((o = !0), p.length && (r = !0)),
  ...
  function ie(t, e, n) {
    for (
      var i, a, r = n.padding, o = e.x, s = e.y, l = 0, d = t.length;
      l < d;
      ++l
    )
      (a = (i = t[l]).box),
        i.horizontal
          ? ((a.left = a.fullWidth ? r.left : e.left),
            (a.right = a.fullWidth ? n.outerWidth - r.right : e.left + e.w),
            (a.top = s),
            (a.bottom = s + a.height),
  ...
  var ae,
    re = {
      ...
      update: function (n, t, e) {
        ...
        n &&
          ((i = n.options.layout || {}),
          (r = t - (a = W.options.toPadding(i.padding)).width),
          (o = e - a.height),
          (g = (function (t) {
          ...
          (h = $t(
            { maxPadding: $t({}, a), w: r, h: o, x: a.left, y: a.top },
            a
          )),
          (function (t, e) {
            for (var n, i = 0, a = t.length; i < a; ++i)
              ((n = t[i]).width = n.horizontal
                ? n.box.fullWidth && e.availableWidth
                : e.vBoxMaxWidth),
  ...
  function be(n, i, a) {
    var t,
      ...
      h = (u.resizer = (function (t) {
        ...
        return (
          ge(n, "scroll", a.bind(n, "expand")),
          ge(i, "scroll", a.bind(i, "shrink")),
          e
        );
      })(
        ((r = !(t = function () {
          var t, e;
          u.resizer &&
            ((e = (t = a.options.maintainAspectRatio && n.parentNode)
              ? t.clientWidth
              : 0),
            i(me("resize", a)),
            t && t.clientWidth < e && a.canvas && i(me("resize", a)));
        })),
        function () {
  ...
  var xe = {
    ...
    acquireContext: function (t, e) {
      ...
      return d && d.canvas === t
        ? (this._ensureLoaded(t),
          ...
          (null !== l && "" !== l) ||
            (void 0 !== (a = ce(n, "width")) && (n.width = a)),
          (null !== s && "" !== s) ||
            ("" === n.style.height
              ? (n.height = n.width / (i.options.aspectRatio || 2))
              : ((r = ce(n, "height")), void 0 !== a && (n.height = r))),
          d)
        : null;
    },
    ...
    addEventListener: function (r, t, o) {
      ...
      "resize" !== t
        ? ge(
            n,
            t,
            (((e = o[se] || (o[se] = {})).proxies || (e.proxies = {}))[
              r.id + "_" + t
            ] = function (t) {
              var e, n, i, a;
              o(
                ((n = r),
                (i = he[(e = t).type] || e.type),
                (a = W.getRelativePosition(e, n)),
                me(i, n, a.x, a.y, e))
              );
            })
          )
    ...
    removeEventListener: function (t, e, n) {
      var i,
        ...
        u = t.canvas;
      "resize" !== e
        ? (i = ((n[se] || {}).proxies || {})[t.id + "_" + e]) && pe(u, e, i)
        : ((l = (a = u)[se] || {}),
          (d = l.resizer),
          delete l.resizer,
          (o = (r = a)[se] || {}),
  ...
  var ke = {
      ...
      notify: function (t, e, n) {
        for (
          var i, a, r, o, s = this.descriptors(t), l = s.length, d = 0;
          d < l;
          ++d
        )
          if (
            "function" == typeof (o = (a = (i = s[d]).plugin)[e]) &&
            ((r = [t].concat(n || [])).push(i.options), !1 === o.apply(a, r))
          )
            return !1;
        return !0;
      },
        ...
        return (
          this._plugins.concat(n.plugins || []).forEach(function (t) {
            ...
            -1 === i.indexOf(t) &&
              ((e = t.id),
              !1 !== (n = r[e]) &&
                (!0 === n && (n = W.clone(N.global.plugins[e])),
                i.push(t),
    ...
    we = {
      ...
      getScaleDefaults: function (t) {
        return this.defaults.hasOwnProperty(t)
          ? W.merge({}, [N.scale, this.defaults[t]])
          : {};
      },
      updateScaleDefaults: function (t, e) {
        this.defaults.hasOwnProperty(t) &&
          (this.defaults[t] = W.extend(this.defaults[t], e));
      },
    ...
    tooltips: {
      ...
      callbacks: {
        ...
        label: function (t, e) {
          ...
          return (
            n && (n += ": "),
            W.isNullOrUndef(t.value) ? (n += t.yLabel) : (n += t.value),
            n
          );
        },
  ...
  var Ce = {
    average: function (t) {
      ...
      for (var e = 0, n = 0, i = 0, a = 0, r = t.length; a < r; ++a) {
        ...
        s &&
          s.hasValue() &&
          ((e += (o = s.tooltipPosition()).x), (n += o.y), ++i);
      }
      return { x: e / i, y: n / i };
    },
    nearest: function (t, e) {
      for (
        ...
        h &&
          h.hasValue() &&
          ((d = h.getCenterPoint()),
          (u = W.distanceBetweenPoints(e, d)) < o && ((o = u), (n = h)));
      }
      return (
        n && ((a = (i = n.tooltipPosition()).x), (r = i.y)), { x: a, y: r }
      );
    },
  };
  function Pe(t, e) {
    return (
      e && (W.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t
    );
  }
  function Ae(t) {
  ...
  var Fe = Y.extend({
    ...
    update: function (t) {
      var e,
        ...
        I = { x: M.caretX, y: M.caretY };
      if (C.length) {
        S.opacity = 1;
        for (
          var F = [],
            L = [],
            I = Ce[w.position].call(k, C, k._eventPosition),
            O = [],
            R = 0,
            z = C.length;
          R < z;
          ...
          O.push(
            ...
            (a = e._index),
            (r = e._datasetIndex),
            (s = (o = e._chart.getDatasetMeta(r).controller)._getIndexScale()),
            (l = o._getValueScale()),
            {
        ...
        w.filter &&
          ...
          (T = (function (t, e) {
            ...
            var f = 0;
            return (
              (n.font = W.fontString(d, e._titleFontStyle, e._titleFontFamily)),
              W.each(e.title, c),
              (n.font = W.fontString(u, e._bodyFontStyle, e._bodyFontFamily)),
              W.each(e.beforeBody.concat(e.afterBody), c),
          ...
          (h = A =
            (function (t, e) {
              ...
              i.y < e.height
                ? (s = "top")
                : i.y > a.height - e.height && (s = "bottom");
              ...
              n(i.x)
                ? ((o = "left"), h(i.x) && ((o = "center"), (s = f(i.y))))
                : u(i.x) &&
                  ((o = "right"), c(i.x) && ((o = "center"), (s = f(i.y))));
              var g = t._options;
              return {
          ...
          "right" === b
            ? (f -= u.width)
            : "center" === b &&
              ((f -= u.width / 2) + u.width > c.width &&
                (f = c.width - u.width),
              f < 0 && (f = 0)),
          "top" === x
            ? (g += y)
            : (g -= "bottom" === x ? u.height + y : u.height / 2),
          "center" === x
            ? "left" === b
              ? (f += y)
              : "right" === b && (f -= y)
      ...
      return (
        "center" === f
          ? ((r = p + v / 2),
            (o =
              "left" === c
                ? ((i = (d = g) - u), (l = d), (a = r + u), r - u)
                : ((i = (d = g + m) + u), (l = d), (a = r - u), r + u)))
          : ((l =
              ((d =
                "left" === c
                  ? (i = g + h + u) - u
            ...
            "top" === f
              ? ((r = (a = p) - u), (o = a))
              : ((r = (a = p + v) + u), (o = a), (s = l), (l = d), (d = s))),
        { x1: d, x2: i, x3: l, y1: a, y2: r, y3: o }
      );
    },
      ...
      if (s) {
        ...
        for (
          t.x = Te(e, e._titleAlign),
            ...
            n.font = W.fontString(i, e._titleFontStyle, e._titleFontFamily),
            r = 0;
          r < s;
          ++r
        )
    ...
    drawBody: function (e, t, n) {
      ...
      for (
        n.textAlign = p,
          n.textBaseline = "middle",
          n.font = W.fontString(f, t._bodyFontStyle, t._bodyFontFamily),
          e.x = Te(t, _),
          n.fillStyle = t.bodyFontColor,
          W.each(t.beforeBody, i),
          b = v && "right" !== _ ? ("center" === p ? f / 2 + 1 : f + 2) : 0,
          l = 0,
          u = m.length;
        l < u;
        ++l
        ...
        for (
          ...
          v &&
            ...
            n.fillRect(y.leftForLtr(c, f), e.y, f, f),
            (n.lineWidth = 1),
            (n.strokeStyle = o.borderColor),
            n.strokeRect(y.leftForLtr(c, f), e.y, f, f),
            (n.fillStyle = o.backgroundColor),
            n.fillRect(
              y.leftForLtr(y.xPlus(c, 1), f - 2),
              e.y + 1,
              f - 2,
              f - 2
            ),
    ...
    draw: function () {
      ...
      0 !== r.opacity &&
        ...
        (e = { x: r.x, y: r.y }),
        (n = Math.abs(r.opacity < 0.001) ? 0 : r.opacity),
        (i =
          r.title.length ||
          r.beforeBody.length ||
          r.body.length ||
        ...
        this._options.enabled &&
          ...
          (a.save(),
          (a.globalAlpha = n),
          this.drawBackground(e, r, a, t),
          (e.y += r.yPadding),
          W.rtl.overrideTextDirection(a, r.textDirection),
          this.drawTitle(e, r, a),
          this.drawBody(e, r, a),
          this.drawFooter(e, r, a),
          W.rtl.restoreTextDirection(a, r.textDirection),
          a.restore()));
    },
    handleEvent: function (t) {
      ...
      return (
        ...
        (e = !W.arrayEquals(n._active, n._lastActive)) &&
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (o = n[t][a]),
              ...
              !e[t][a].type || (o.type && o.type !== e[t][a].type)
                ? W.merge(e[t][a], [we.getScaleDefaults(r), o])
                : W.merge(e[t][a], o);
    ...
    return W.merge({}, [].slice.call(arguments), {
      merger: function (t, e, n, i) {
        ...
        "scales" === t
          ? (e[t] = Oe(a, r))
          : "scale" === t
          ? (e[t] = W.merge(a, [we.getScaleDefaults(r.type), r]))
          : W._merger(t, e, n, i);
      },
    });
  }
  ...
  W.extend(Ee.prototype, {
    ...
    initialize: function () {
      var t = this;
      return (
        ke.notify(t, "beforeInit"),
        W.retinaScale(t, t.options.devicePixelRatio),
        t.bindEvents(),
        t.options.responsive && t.resize(!0),
        t.initToolTip(),
        ke.notify(t, "afterInit"),
        t
      );
    },
    clear: function () {
    ...
    resize: function (t) {
      ...
      (n.width === o && n.height === s) ||
        ...
        (a.style.width = o + "px"),
        (a.style.height = s + "px"),
        W.retinaScale(n, i.devicePixelRatio),
        t) ||
        ((e = { width: o, height: s }),
        ke.notify(n, "resize", [e]),
        i.onResize && i.onResize(n, e),
        n.stop(),
        n.update({ duration: i.responsiveAnimationDuration }));
    },
    ...
    buildOrUpdateControllers: function () {
      for (
        var t = this, e = [], n = t.data.datasets, i = 0, a = n.length;
        i < a;
        i++
      ) {
        var r = n[i],
        ...
        if (
          (o.type &&
            o.type !== s &&
            (t.destroyDatasetMeta(i), (o = t.getDatasetMeta(i))),
          (o.type = s),
          (o.order = r.order || 0),
          (o.index = i),
          o.controller)
    ...
    update: function (t) {
      ...
      if (
        ...
        (n = Re(N.global, N[e.config.type], n)),
        ...
        ke._invalidate(i),
        !1 !== ke.notify(i, "beforeUpdate"))
      ) {
        i.tooltip._data = i.data;
        for (
          var a = i.buildOrUpdateControllers(),
            r = 0,
            o = i.data.datasets.length;
          r < o;
          r++
        )
    ...
    updateLayout: function () {
      var e = this;
      !1 !== ke.notify(e, "beforeLayout") &&
        (re.update(this, this.width, this.height),
        (e._layers = []),
        W.each(
          e.boxes,
          function (t) {
        ...
        ke.notify(e, "afterScaleUpdate"),
        ke.notify(e, "afterLayout"));
    },
    ...
    updateDataset: function (t) {
      var e = this.getDatasetMeta(t),
        n = { meta: e, index: t };
      !1 !== ke.notify(this, "beforeDatasetUpdate", [n]) &&
        (e.controller._update(), ke.notify(this, "afterDatasetUpdate", [n]));
    },
    render: function (t) {
      var e = this;
        ...
        return (
          n && i
            ? ((r = new X({
              ...
              K.addAnimation(e, r, i, a))
            : (e.draw(), o(new X({ numSteps: 0, chart: e }))),
          e
        );
      }
    },
    draw: function (t) {
      ...
      if (
        (i.clear(),
        W.isNullOrUndef(t) && (t = 1),
        i.transition(t),
        !(i.width <= 0 || i.height <= 0) &&
          !1 !== ke.notify(i, "beforeDraw", [t]))
      ) {
    ...
    drawDataset: function (t, e) {
      ...
      !1 !== ke.notify(this, "beforeDatasetDraw", [n]) &&
        (t.controller.draw(e), ke.notify(this, "afterDatasetDraw", [n]));
    },
    _drawTooltip: function (t) {
      var e = this.tooltip,
        n = { tooltip: e, easingValue: t };
      !1 !== ke.notify(this, "beforeTooltipDraw", [n]) &&
        (e.draw(), ke.notify(this, "afterTooltipDraw", [n]));
    },
    getElementAtEvent: function (t) {
      return Zt.modes.single(this, t);
    },
    getElementsAtEvent: function (t) {
      return Zt.modes.label(this, t, { intersect: !0 });
    },
    getElementsAtXAxis: function (t) {
      return Zt.modes["x-axis"](this, t, { intersect: !0 });
    },
    ...
    getDatasetAtEvent: function (t) {
      return Zt.modes.dataset(this, t, { intersect: !0 });
    },
    ...
    bindEvents: function () {
      ...
      W.each(e.options.events, function (t) {
        ...
        e.options.responsive &&
          ...
          _e.addEventListener(e, "resize", i),
          (n.resize = i));
    },
    ...
    handleEvent: function (t) {
      ...
      return (
        ...
        W.callback(i.onHover || i.hover.onHover, [t.native, n.active], n),
        ...
        (e = !W.arrayEquals(n.active, n.lastActive)),
        ...
        linear: function (t, e, n) {
          ...
          return 0 !== t
            ? Math.max(Math.abs(n[0]), Math.abs(n[n.length - 1])) < 1e-4
              ? ((a = W.log10(Math.abs(t))),
                (r = Math.floor(a) - Math.floor(s)),
  ...
  function Ze(t) {
    var e, n;
    return t.display
      ? ((e = W.options._parseFont(t)),
        (n = W.options.toPadding(t.padding)),
        e.lineHeight + n.height)
      : 0;
  }
  function $e(t, e) {
    return W.extend(
      W.options._parseFont({
  ...
  function Je(t) {
    var e = $e(t, t.minor);
    return { minor: e, major: t.major.enabled ? $e(t, t.major) : e };
  }
  function Qe(t) {
    for (var e, n = [], i = 0, a = t.length; i < a; ++i)
  ...
  function tn(t, e, n, i) {
    ...
    for (
      ...
      u++, (s = Math.round(l + u * e));
    for (r = Math.max(l, 0); r < d; r++)
      (o = t[r]),
        r === s
          ? ((o._index = r), u++, (s = Math.round(l + u * e)))
          : delete o.label;
  }
  N._set("scale", {
    display: !0,
  ...
  var en = Y.extend({
      ...
      return (
        ...
        (r = l._convertTicksToLabels(
          s
            ? (function (t) {
                for (
                  var e = [], n = t.length / u, i = 0, a = t.length;
                  i < a;
                  i += n
                )
    ...
    afterBuildTicks: function (t) {
      ...
      return Ue(t) && t.length
        ? W.callback(e.options.afterBuildTicks, [e, t])
        : ((e.ticks =
            W.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks),
          t);
    },
    ...
    calculateTickRotation: function () {
      var t,
        ...
        c = d.maxRotation,
        f = h;
      !s._isVisible() || !d.display || c <= h || u <= 1 || !s.isHorizontal()
        ? (s.labelRotation = h)
        : ((e = (t = s._getLabelSizes()).widest.width),
          (n = t.highest.height - t.highest.offset),
          (i = Math.min(s.maxWidth, s.chart.width - e)),
          e + 6 > (l.offset ? s.maxWidth / u : i / (u - 1)) &&
            ((a = i / (u - (l.offset ? 0.5 : 1))),
            (r = s.maxHeight - Ke(l.gridLines) - d.padding - Ze(l.scaleLabel)),
            (o = Math.sqrt(e * e + n * n)),
            (f = W.toDegrees(
              Math.min(
    ...
    fit: function () {
      ...
      P ? (x.width = b.maxWidth) : S && (x.width = Ke(M) + Ze(w)),
        ...
        k.display &&
          S &&
          ((t = Je(k)),
          (n = (e = b._getLabelSizes()).first),
          (i = e.last),
          (a = e.widest),
          (r = e.highest),
          (o = 0.4 * t.minor.lineHeight),
          (s = k.padding),
          P
            ? ((l = 0 !== b.labelRotation),
              (d = W.toRadians(b.labelRotation)),
              (u = Math.cos(d)),
              (c =
                (h = Math.sin(d)) * a.width +
                u * (r.height - (l ? r.offset : 0)) +
                (l ? 0 : o)),
              (x.height = Math.min(b.maxHeight, x.height + c + s)),
              (g = b.getPixelForTick(0) - b.left),
              (p = b.right - b.getPixelForTick(b.getTicks().length - 1)),
              (m = l
                ? ((f = C
                    ? u * n.width + h * n.offset
                    : h * (n.height - n.offset)),
                  C ? h * (i.height - i.offset) : u * i.width + h * i.offset)
                : ((f = n.width / 2), i.width / 2)),
              (b.paddingLeft =
                Math.max(((f - g) * b.width) / (b.width - g), 0) + 3),
              (b.paddingRight =
                Math.max(((m - p) * b.width) / (b.width - p), 0) + 3))
            : ((v = k.mirror ? 0 : a.width + s + o),
              (x.width = Math.min(b.maxWidth, x.width + v)),
              (b.paddingTop = n.height / 2),
              (b.paddingBottom = i.height / 2))),
        b.handleMargins(),
        P
          ? ((b.width = b._length = y.width - b.margins.left - b.margins.right),
            (b.height = x.height))
          : ((b.width = x.width),
            (b.height = b._length =
              y.height - b.margins.top - b.margins.bottom));
    },
          ...
          ((t._labelSizes = e =
            (function (t, e, n, i) {
                  ...
                  if (Ue(o))
                    for (a = 0, r = o.length; a < r; ++a)
                      (f = o[a]),
                        Ye(f) ||
                          Ue(f) ||
                          ((h = W.measureText(t, d.data, d.gc, h, f)),
                          (c += u));
              ...
              return (
                ...
                (p = x.indexOf(Math.max.apply(null, x))),
                { first: k(0), last: k(v - 1), widest: k(g), highest: k(p) }
              );
            })(t.ctx, Je(t.options.ticks), t.getTicks(), t.longestTextCache)),
      ...
      var e,
        ...
        a = Ue(t)
          ? ((e = +this.getRightValue(t[0])),
            ...
            (i = Math.min(e, n)),
            Math.max(e, n))
          : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t));
      return { min: i, max: a, start: e, end: n };
    },
    ...
    _autoSkip: function (t) {
      ...
      if (
        ...
        return (
          (a = 1 < d ? (h - u) / (d - 1) : null),
          tn(t, i, W.isNullOrUndef(a) ? 0 : u - a, u),
          tn(t, i, h, W.isNullOrUndef(a) ? t.length : h + a),
          Qe(t)
        );
      }
      return tn(t, i), Qe(t);
    ...
    _computeGridLineItems: function (t) {
      ...
      for (
        ...
        (a = C[i] || {}),
          (Ye(a.label) && i < C.length) ||
            ((b =
              i === x.zeroLineIndex && _.offset === M
                ? ((p = k.zeroLineWidth),
                  (m = k.zeroLineColor),
                  (v = k.zeroLineBorderDash || []),
                  k.zeroLineBorderDashOffset || 0)
                : ((p = Xe(k.lineWidth, i, 1)),
                  (m = Xe(k.color, i, "rgba(0,0,0,0.1)")),
                  (v = k.borderDash || []),
                  k.borderDashOffset || 0)),
            void 0 !==
              (r = (function (t, e, n) {
                var i,
                  a = t.getTicks().length,
                ...
                if (
                  !(
                    ...
                    (o += r < e ? i : -i) < s - 1e-6 || l + 1e-6 < o)
                  )
                )
                  return o;
              })(x, a._index || i, M)) &&
              ((o = F(y, r, p)),
              S ? (s = d = h = f = o) : (l = u = c = g = o),
              D.push({
                tx1: s,
                ty1: l,
                tx2: d,
    ...
    _computeLabelItems: function () {
      for (
        var t,
          ...
          _ =
            "top" === c
              ? ((i = d.bottom - b - v), x ? "left" : "center")
              : "bottom" === c
              ? ((i = d.top + b + v), x ? "right" : "center")
              : "left" === c
              ? ((n = d.right - (f ? 0 : b) - v), f ? "left" : "right")
              : ((n = d.left + (f ? 0 : b) + v), f ? "right" : "left"),
          k = 0,
          w = p.length;
        k < w;
        ++k
        ...
        (e = (t = p[k]).label),
          Ye(e) ||
            ((a = d.getPixelForTick(t._index || k) + h.labelOffset),
            (o = (r = t.major ? m.major : m.minor).lineHeight),
            (s = Ue(e) ? e.length : 1),
            (l = g
              ? ((n = a),
                "top" === c ? ((x ? 1 : 0.5) - s) * o : (x ? 0 : 0.5) * o)
              : ((i = a), ((1 - s) * o) / 2)),
            y.push({
              x: n,
              y: i,
      ...
      if (n.display) {
        for (
          var i,
            ...
            g = e.chart,
            p = W._alignPixel,
            m = n.drawBorder ? Xe(n.lineWidth, 0, 0) : 0,
            v =
              e._gridLineItems ||
          ...
          (i = (r = v[b]).width),
            ...
            i &&
              ...
              (f.strokeStyle = a),
              f.setLineDash &&
                (f.setLineDash(r.borderDash),
                (f.lineDashOffset = r.borderDashOffset)),
              f.beginPath(),
              n.drawTicks && (f.moveTo(r.tx1, r.ty1), f.lineTo(r.tx2, r.ty2)),
              n.drawOnChartArea && (f.moveTo(r.x1, r.y1), f.lineTo(r.x2, r.y2)),
              f.stroke(),
              f.restore());
        m &&
          ((u = m),
          (h = Xe(n.lineWidth, v.ticksLength - 1, 1)),
          (c = v.borderValue),
          e.isHorizontal()
            ? ((o = p(g, e.left, u) - u / 2),
              (s = p(g, e.right, h) + h / 2),
              (l = d = c))
            : ((l = p(g, e.top, u) - u / 2),
              (d = p(g, e.bottom, h) + h / 2),
              (o = s = c)),
          (f.lineWidth = m),
          (f.strokeStyle = Xe(n.color, 0)),
          f.beginPath(),
          f.moveTo(o, l),
          f.lineTo(s, d),
          f.stroke());
      ...
      if (t.options.ticks.display)
        for (
          var e,
            ...
            o,
            s = t.ctx,
            l = t._labelItems || (t._labelItems = t._computeLabelItems()),
            d = 0,
            u = l.length;
          d < u;
          ++d
          ...
          if (
            ...
            for (e = 0, n = r.length; e < n; ++e)
              s.fillText("" + r[e], 0, o), (o += a.lineHeight);
    ...
    _drawTitle: function () {
      var t,
        ...
        c = h.scaleLabel;
      c.display &&
        ((t = Ge(c.fontColor, N.global.defaultFontColor)),
        (e = W.options._parseFont(c)),
        (n = W.options.toPadding(c.padding)),
        (i = e.lineHeight / 2),
        (a = h.position),
        (l = 0),
        d.isHorizontal()
          ? ((o = d.left + d.width / 2),
            (s = "bottom" === a ? d.bottom - i - n.bottom : d.top + i + n.top))
          : ((o = (r = "left" === a)
              ? d.left + i + n.top
              : d.right - i - n.top),
            (s = d.top + d.height / 2),
    ...
    _getMatchingVisibleMetas: function (e) {
      ...
      return n.chart._getSortedVisibleDatasetMetas().filter(function (t) {
        return (
          (!e || t.type === e) && (i ? t.xAxisID === n.id : t.yAxisID === n.id)
        );
      });
    },
  });
    ...
    rn = nn.extend({
      ...
      getPixelForValue: function (t, e, n) {
        var i,
          ...
          o = this;
        return (
          an(e) || an(n) || (t = o.chart.data.datasets[n].data[e]),
          an(t) || (i = o.isHorizontal() ? t.x : t.y),
          (void 0 !== i || (void 0 !== t && isNaN(e))) &&
            ((a = o._getLabels()),
            (t = W.valueOrDefault(i, t)),
  ...
  var on = W.noop,
    ...
    ln = nn.extend({
      getRightValue: function (t) {
        return "string" == typeof t
          ? +t
          : nn.prototype.getRightValue.call(this, t);
      },
      handleTickRangeOptions: function () {
        ...
        i.beginAtZero &&
          ((t = W.sign(n.min)),
          (e = W.sign(n.max)),
          t < 0 && e < 0 ? (n.max = 0) : 0 < t && 0 < e && (n.min = 0));
        ...
        void 0 !== i.min
          ...
          : void 0 !== i.suggestedMin &&
            (null === n.min
              ? (n.min = i.suggestedMin)
              : (n.min = Math.min(n.min, i.suggestedMin))),
          void 0 !== i.max
            ? (n.max = i.max)
            : void 0 !== i.suggestedMax &&
              (null === n.max
                ? (n.max = i.suggestedMax)
                : (n.max = Math.max(n.max, i.suggestedMax))),
          a != r &&
            n.min >= n.max &&
            (a ? (n.max = n.min + 1) : (n.min = n.max - 1)),
      ...
      buildTicks: function () {
        var p = this,
          ...
          n = (p.ticks = (function () {
            ...
            (i = Math.ceil(c / f) - Math.floor(h / f)) > s &&
              (f = W.niceNum((i * f) / s / o) * o),
              r || sn(u)
                ? (t = Math.pow(10, W._decimalPlaces(f)))
                : ((t = Math.pow(10, u)), (f = Math.ceil(f * t) / t)),
              (e = Math.floor(h / f) * f),
              (n = Math.ceil(c / f) * f),
              r &&
                (!sn(l) && W.almostWhole(l / f, f / 1e3) && (e = l),
                !sn(d) && W.almostWhole(d / f, f / 1e3) && (n = d)),
              (i = (n - e) / f),
              (i = W.almostEquals(i, Math.round(i), f / 1e3)
                ? Math.round(i)
                : Math.ceil(i)),
              (e = Math.round(e * t) / t),
              (n = Math.round(n * t) / t),
        ...
        p.handleDirectionalChanges(),
          ...
          (p.min = W.min(n)),
          t.reverse
            ? (n.reverse(), (p.start = p.max), (p.end = p.min))
            : ((p.start = p.min), (p.end = p.max));
      },
      convertTicksToLabels: function () {
        var t = this;
    ...
    dn = { position: "left", ticks: { callback: qe.formatters.linear } };
  var un = ln.extend({
    determineDataLimits: function () {
      var t,
        e,
                ...
                for (
                  var a,
                    ...
                    d =
                      ...
                      (s = [
                        n.type,
                        void 0 === o && void 0 === n.stack ? n.index : "",
                        n.stack,
                      ].join(".")),
                      void 0 === r[s] && (r[s] = { pos: [], neg: [] }),
                      r[s]),
                    u = d.pos,
                    h = d.neg,
                    c = i.length,
    ...
    _computeTickLimit: function () {
      ...
      return this.isHorizontal()
        ...
        : ((t = W.options._parseFont(this.options.ticks)),
  ...
  var pn = nn.extend({
    determineDataLimits: function () {
      ...
      if (void 0 === u)
        for (c = 0; c < s.length; c++)
          if (
            ((t = o.getDatasetMeta(c)),
            o.isDatasetVisible(c) && d(t) && void 0 !== t.stack)
          ) {
            u = !0;
            break;
          }
      if (r.stacked || u) {
        for (var h = {}, c = 0; c < s.length; c++) {
          var f = [
            (t = o.getDatasetMeta(c)).type,
            void 0 === r.stacked && void 0 === t.stack ? c : "",
            t.stack,
          ].join(".");
          if (o.isDatasetVisible(c) && d(t))
            for (
              void 0 === h[f] && (h[f] = []), n = 0, i = (e = s[c].data).length;
              n < i;
              n++
            ) {
              var g = h[f],
            ...
            for (n = 0, i = (e = s[c].data).length; n < i; n++)
              (p = a._parseValue(e[n])),
                isNaN(p.min) ||
                  ...
                  p.min < 0 ||
                  p.max < 0 ||
                  ((a.min = Math.min(p.min, a.min)),
                  (a.max = Math.max(p.max, a.max)),
                  0 !== p.min &&
                    (a.minNotZero = Math.min(p.min, a.minNotZero)));
    ...
    handleTickRangeOptions: function () {
      ...
      (t.min = gn(e.min, t.min)),
        ...
        t.min === t.max &&
          (0 !== t.min && null !== t.min
            ? ((t.min = Math.pow(10, Math.floor(cn(t.min)) - 1)),
              (t.max = Math.pow(10, Math.floor(cn(t.max)) + 1)))
            : ((t.min = 1), (t.max = 10))),
        null === t.min && (t.min = Math.pow(10, Math.floor(cn(t.max)) - 1)),
        null === t.max &&
          (t.max = 0 !== t.min ? Math.pow(10, Math.floor(cn(t.min)) + 1) : 10),
        null === t.minNotZero &&
          (0 < t.min
            ? (t.minNotZero = t.min)
            : t.max < 1
            ? (t.minNotZero = Math.pow(10, Math.floor(cn(t.max))))
            : (t.minNotZero = 1));
    },
    buildTicks: function () {
      var t = this,
        ...
        a = (t.ticks = (function (t, e) {
          ...
          0 === r
            ? ((n = Math.floor(cn(e.minNotZero))),
              (i = Math.floor(e.minNotZero / Math.pow(10, n))),
              a.push(r),
              (r = i * Math.pow(10, n)))
            : ((n = Math.floor(cn(r))), (i = Math.floor(r / Math.pow(10, n))));
          for (
    ...
    _configure: function () {
      ...
      nn.prototype._configure.call(t),
        0 === e &&
          ...
          (n =
            hn(t.options.ticks.fontSize, N.global.defaultFontSize) /
            t._length)),
        (t._startValue = cn(e)),
        (t._valueOffset = n),
    ...
    getPixelForValue: function (t) {
      ...
      return (
        (t = +e.getRightValue(t)) > e.min &&
          0 < t &&
          (n = (cn(t) - e._startValue) / e._valueRange + e._valueOffset),
  ...
  function yn(t) {
    ...
    return e.display && t.display
      ? mn(e.fontSize, N.global.defaultFontSize) + 2 * e.backdropPaddingY
      : 0;
  }
  ...
  var wn = ln.extend({
    ...
    fit: function () {
      ...
      t.display && t.pointLabels.display
        ? (function (t) {
            ...
            for (
              var o, s, l, d = t.chart.data.labels.length, u = 0;
              u < d;
              u++
            ) {
              (n = t.getPointPosition(u, t.drawingArea + 5)),
                ...
                (l = t.pointLabels[u]),
                (e = W.isArray(l)
                  ? { w: W.longestText(o, o.font, l), h: l.length * s }
                  : { w: o.measureText(l).width, h: s }),
    ...
    getBasePosition: function (t) {
      ...
      return this.getPointPositionForValue(
        t || 0,
        this.beginAtZero ? 0 : e < 0 && n < 0 ? n : 0 < e && 0 < n ? e : 0
      );
    },
    _drawGrid: function () {
      var t,
      ...
      if (
        (r.pointLabels.display &&
          (function (t) {
            ...
            for (
              var s, l, d, u, h = t.chart.data.labels.length - 1;
              0 <= h;
              h--
            ) {
              var c = 0 === h ? a / 2 : 0,
        ...
        o.display &&
          W.each(i.ticks, function (t, e) {
            0 !== e &&
              ((n = i.getDistanceFromCenterForValue(i.ticksAsNumbers[e])),
              (function (t, e, n, i) {
                var a,
                  r = t.ctx,
                  o = e.circular,
                ...
                if ((o || s) && l && d) {
                  if (
                    ...
                    for (var u = 1; u < s; u++)
                      (a = t.getPointPosition(u, n)), r.lineTo(a.x, a.y);
                  }
        ...
        for (
          a.save(),
            ...
            a.strokeStyle = d,
            a.setLineDash &&
              (a.setLineDash(bn([s.borderDash, o.borderDash, []])),
              (a.lineDashOffset = bn([
                s.borderDashOffset,
                o.borderDashOffset,
                0,
          ...
          (n = i.getDistanceFromCenterForValue(
    ...
    _drawLabels: function () {
      ...
      l.display &&
        ((t = o.getIndexAngle(0)),
        (a = W.options._parseFont(l)),
        (r = mn(l.fontColor, N.global.defaultFontColor)),
        s.save(),
        (s.font = a.string),
        s.translate(o.xCenter, o.yCenter),
        s.rotate(t),
        (s.textAlign = "center"),
        (s.textBaseline = "middle"),
        W.each(o.ticks, function (t, e) {
          (0 === e && !l.reverse) ||
            ((n = o.getDistanceFromCenterForValue(o.ticksAsNumbers[e])),
            l.showLabelBackdrop &&
              ((i = s.measureText(t).width),
              (s.fillStyle = l.backdropColor),
              s.fillRect(
                -i / 2 - l.backdropPaddingX,
                -n - a.size / 2 - l.backdropPaddingY,
                i + 2 * l.backdropPaddingX,
                a.size + 2 * l.backdropPaddingY
              )),
            (s.fillStyle = r),
            s.fillText(t, 0, -n));
        }),
  ...
  function Rn(t, e) {
    ...
    return (
      ...
      W.isFinite(o) || (o = "string" == typeof r ? n.parse(o, r) : n.parse(o)),
      null !== o
        ? +o
        : (a ||
            "function" != typeof r ||
            ((o = r(e)), W.isFinite(o) || (o = n.parse(o))),
          o)
    );
  }
  function zn(t, e) {
  ...
  function Nn(t, e, n, i) {
    for (var a, r, o = Tn.length, s = Tn.indexOf(t); s < o - 1; ++s)
      if (
        ((r = (a = Dn[Tn[s]]).steps ? a.steps : An),
        a.common && Math.ceil((n - e) / (r * a.size)) <= i)
      )
        return Tn[s];
    return Tn[o - 1];
  }
  function Bn(l, t, e) {
    for (var n, i = [], a = {}, r = t.length, o = 0; o < r; ++o)
      (a[(n = t[o])] = o), i.push({ value: n, major: !1 });
    return 0 !== r && e
      ? (function (t, e, n) {
          for (
            var i,
              a = l._adapter,
              r = +a.startOf(t[0].value, n),
  ...
  var En = nn.extend({
    ...
    update: function () {
      ...
      return (
        Mn("time scale", e.format, "time.format", "time.parser"),
        Mn("time scale", e.min, "time.min", "ticks.min"),
        Mn("time scale", e.max, "time.max", "ticks.max"),
        W.mergeIf(e.displayFormats, n.formats()),
        nn.prototype.update.apply(this, arguments)
      );
    },
    getRightValue: function (t) {
      return (
    ...
    determineDataLimits: function () {
      ...
      g.length && ((u = Math.min(u, g[0])), (h = Math.max(h, g[g.length - 1]))),
        ...
        (r._table = []),
        (r._timestamps = { data: c, datasets: f, labels: g });
    },
    buildTicks: function () {
      var t,
        e,
          ...
          "data" === b || ("auto" === b && "series" === x)
            ...
            : (function (t, e) {
                var n,
                  ...
                  u = [];
                if (
                  (l && (d = +i.startOf(d, "isoWeek", l)),
                  (d = +i.startOf(d, l ? "day" : o)),
                  i.diff(e, t, o) > 1e5 * s)
                )
                  throw (
                    t +
      ...
      for (
        "ticks" === c.bounds && p.length && ((d = p[0]), (u = p[p.length - 1])),
          d = zn(h, Fn(c)) || d,
          u = zn(h, Ln(c)) || u,
          t = 0,
          e = p.length;
      ...
      return (
        ...
        (h._unit =
          g.unit ||
          (f.autoSkip
            ? Nn(g.minUnit, h.min, h.max, v)
            : (function (t, e, n, i, a) {
                for (var r, o = Tn.length - 1; o >= Tn.indexOf(n); o--)
                  if (
                    ((r = Tn[o]),
                    Dn[r].common && t._adapter.diff(a, i, r) >= e - 1)
                  )
                    return r;
                return Tn[n ? Tn.indexOf(n) : 0];
              })(h, m.length, g.minUnit, h.min, h.max))),
        (h._majorUnit =
          f.major.enabled && "year" !== h._unit
            ? (function (t) {
                for (var e = Tn.indexOf(t) + 1, n = Tn.length; e < n; ++e)
                  if (Dn[Tn[e]].common) return Tn[e];
              })(h._unit)
            : void 0),
        (h._table = (function (t, e, n) {
          ...
          for (s.push(n), l = 0, d = s.length; l < d; ++l)
            (r = s[l + 1]),
              (i = s[l - 1]),
              (a = s[l]),
              (void 0 !== i && void 0 !== r && Math.round((r + i) / 2) === a) ||
                o.push({ time: a, pos: l / (d - 1) });
          return o;
        ...
        (h._offsets =
          ...
          c.offset &&
            a.length &&
            ((r = On(i, "time", a[0], "pos")),
            (s = 1 === a.length ? 1 - r : (On(i, "time", a[1], "pos") - r) / 2),
            (o = On(i, "time", a[a.length - 1], "pos")),
            (l =
              1 === a.length
                ? o
                : (o - On(i, "time", a[a.length - 2], "pos")) / 2)),
    ...
    getLabelForIndex: function (t, e) {
      ...
      return (
        W.isObject(s) && (o = n.getRightValue(s)),
        r.tooltipFormat
          ? i.format(Rn(n, o), r.tooltipFormat)
          : "string" == typeof o
          ? o
          : i.format(Rn(n, o), r.displayFormats.datetime)
      );
    },
  ...
  var Un = {
      ...
      afterDatasetsUpdate: function (t, e) {
        for (
          ...
          (a = null),
            (i = (n = t.getDatasetMeta(h)).dataset) &&
              i._model &&
              i instanceof vt.Line &&
              (a = {
        ...
        for (h = 0; h < l; ++h)
          (a = u[h]) &&
            ...
            (a.boundary = (function (u) {
              return (
                (u.el._scale || {}).getPointPositionForValue
                  ? function () {
                      var t,
                        e,
                        n,
                      ...
                      if (!s) return null;
                      for (
                        t = o.ticks.reverse ? r.max : r.min,
                          e = o.ticks.reverse ? r.min : r.max,
                          n = r.getPointPositionForValue(0, t),
                          i = 0;
                        i < s;
                        ++i
                      )
                        (a =
                          ...
                          o.gridLines.circular &&
                            ((a.cx = n.x),
                            (a.cy = n.y),
                            (a.angle = r.getIndexAngle(i) - Math.PI / 2)),
                          d.push(a);
                      return d;
                    }
                  : function () {
                      ...
                      if (
                        ("start" === i
                          ? (a =
                              void 0 === e.scaleBottom
                                ? n.bottom
                                : e.scaleBottom)
                          : "end" === i
                          ? (a = void 0 === e.scaleTop ? n.top : e.scaleTop)
                          : void 0 !== e.scaleZero
                          ? (a = e.scaleZero)
      ...
      beforeDatasetsDraw: function (t) {
        for (
          ...
          (e = s[d].$filler) &&
            ...
            (a = n._children || []),
            (r = e.mapper),
            (o = i.backgroundColor || N.global.defaultColor),
            r &&
              o &&
              a.length &&
              (W.canvas.clipArea(l, t.chartArea),
              (function (t, e, n, i, a, r) {
                ...
                for (t.beginPath(), o = 0, s = g; o < s; ++o)
                  (u = n((d = e[(l = o % g)]._view), l, i)),
                    ...
                    h && c
                      ? ((b = m.push(d)), (x = v.push(u)))
                      : b &&
                        x &&
                        (p
                          ? (h && m.push(d), c && v.push(u))
                          : (qn(t, m, v, b, x),
                            (b = x = 0),
                            (m = []),
                            (v = [])));
  ...
  var Zn = Y.extend({
    ...
    fit: function () {
      var i,
        ...
        v = t.isHorizontal();
      v
        ? ((m.width = t.maxWidth), (m.height = n ? 10 : 0))
        : ((m.width = n ? 10 : 0), (m.height = t.maxHeight)),
        n
          ? ((c.font = f.string),
            v
              ? ((i = t.lineWidths = [0]),
                ...
                W.each(t.legendItems, function (t, e) {
                  ...
                  (0 === e || i[i.length - 1] + n + 2 * h.padding > m.width) &&
                    ((a += g + h.padding), (i[i.length - (0 < e ? 0 : 1)] = 0)),
                    (p[e] = { left: 0, top: 0, width: n, height: g }),
              ...
              : ((r = h.padding),
                ...
                W.each(t.legendItems, function (t, e) {
                  ...
                  0 < e &&
                    u + g + 2 * r > m.height &&
                    ((l += d + h.padding), o.push(d), s.push(u), (u = d = 0)),
                    (d = Math.max(d, n)),
                    (u += g + r),
                    (p[e] = { left: 0, top: 0, width: n, height: g });
                }),
            ...
            (t.width = m.width),
            (t.height = m.height))
          : (t.width = m.width = t.height = m.height = 0);
    },
    afterFit: Gn,
    isHorizontal: function () {
      return (
    ...
    draw: function () {
      var y,
        ...
        z = D.lineWidths;
      n.display &&
        ((y = Yn(n.rtl, D.left, D.minSize.width)),
        (_ = D.ctx),
        (t = Xn(T.fontColor, i.defaultFontColor)),
        (e = W.options._parseFont(T)),
        (k = e.size),
        (_.textAlign = y.textAlign("left")),
        ...
        (C = D.isHorizontal()),
        (P = C
          ? { x: D.left + S(R, z[0]), y: D.top + T.padding, line: 0 }
          : { x: D.left + T.padding, y: D.top + S(L, O[0]), line: 0 }),
        W.rtl.overrideTextDirection(D.ctx, n.textDirection),
        (A = k + T.padding),
        W.each(D.legendItems, function (t, e) {
          ...
          y.setWidth(D.minSize.width),
            C
              ? 0 < e &&
                a + i + T.padding > D.left + D.minSize.width &&
                ((r = P.y += A), P.line++, (a = P.x = D.left + S(R, z[P.line])))
              : 0 < e &&
                r + A > D.top + D.minSize.height &&
                ((a = P.x = a + D.columnWidths[P.line] + T.padding),
                P.line++,
                (r = P.y = D.top + S(L, O[P.line])));
          var o,
            s,
            l,
            d,
          ...
          (c = x),
            ...
            isNaN(w) ||
              w <= 0 ||
              (_.save(),
              (p = Xn(g.lineWidth, F.borderWidth)),
              (_.fillStyle = Xn(g.fillStyle, I)),
              (_.lineCap = Xn(g.lineCap, F.borderCapStyle)),
              (_.lineDashOffset = Xn(g.lineDashOffset, F.borderDashOffset)),
              (_.lineJoin = Xn(g.lineJoin, F.borderJoinStyle)),
              (_.lineWidth = p),
              (_.strokeStyle = Xn(g.strokeStyle, I)),
              _.setLineDash && _.setLineDash(Xn(g.lineDash, F.borderDash)),
              T && T.usePointStyle
                ? ((m = (w * Math.SQRT2) / 2),
                  (v = y.xPlus(c, w / 2)),
                  (b = f + k / 2),
                  W.canvas.drawPoint(_, g.pointStyle, m, v, b, g.rotation))
                : (_.fillRect(y.leftForLtr(c, w), f, w, k),
                  0 !== p && _.strokeRect(y.leftForLtr(c, w), f, w, k)),
              _.restore()),
  ...
  function $n(t, e) {
    var n = new Zn({ ctx: t.ctx, options: e, chart: t });
  ...
  var Jn = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.legend,
          n = t.legend;
        e
          ? (W.mergeIf(e, N.global.legend),
            n ? (re.configure(t, n, e), (n.options = e)) : $n(t, e))
          : n && (re.removeBox(t, n), delete t.legend);
      },
  ...
  var ti = Y.extend({
    ...
    fit: function () {
      ...
      n.display
        ? ((t =
            (W.isArray(n.text) ? n.text.length : 1) *
              W.options._parseFont(n).lineHeight +
            2 * n.padding),
    ...
    draw: function () {
      ...
      if (n.display) {
        var i,
          ...
          c = t.bottom,
          f = t.right;
        (e.fillStyle = W.valueOrDefault(
          n.fontColor,
          N.global.defaultFontColor
        )),
          (e.font = o.string),
          t.isHorizontal()
            ? ((a = h + (f - h) / 2), (r = u + l), (i = f - h))
            : ((a = "left" === n.position ? h + l : f - l),
              (r = u + (c - u) / 2),
              (i = c - u),
              (d = Math.PI * ("left" === n.position ? -0.5 : 0.5))),
          e.save(),
          e.translate(a, r),
          e.rotate(d),
          (e.textAlign = "center"),
    ...
    ri = {
      ...
      beforeUpdate: function (t) {
        var e = t.options.title,
          n = t.titleBlock;
        e
          ? (W.mergeIf(e, N.global.title),
            n ? (re.configure(t, n, e), (n.options = e)) : ei(t, e))
          : n && (re.removeBox(t, n), delete t.titleBlock);
      },
    };
  for (var oi in ((ni.filler = ii),
  (ni.legend = ai),
  (ni.title = ri),
  ((We.helpers = W).where = function (t, e) {
  ...
  (W.splineCurveMonotone = function (t) {
    for (
      var e,
        n,
        i,
      ...
      (e = u[c]).model.skip ||
        ...
        (n = c < h - 1 ? u[c + 1] : null) &&
          !n.model.skip &&
          ((l = n.model.x - e.model.x),
          (e.deltaK = 0 != l ? (n.model.y - e.model.y) / l : 0)),
        !d || d.model.skip
          ? (e.mK = e.deltaK)
          : !n || n.model.skip
          ? (e.mK = d.deltaK)
          : this.sign(d.deltaK) !== this.sign(e.deltaK)
          ? (e.mK = 0)
          : (e.mK = (d.deltaK + e.deltaK) / 2));
    }
    for (c = 0; c < h - 1; ++c)
      (e = u[c]),
        (n = u[c + 1]),
        e.model.skip ||
          n.model.skip ||
          (W.almostEquals(e.deltaK, 0, this.EPSILON)
            ? (e.mK = n.mK = 0)
            : ((i = e.mK / e.deltaK),
              (a = n.mK / e.deltaK),
              (o = Math.pow(i, 2) + Math.pow(a, 2)) <= 9 ||
                ((r = 3 / Math.sqrt(o)),
                (e.mK = i * r * e.deltaK),
                (n.mK = a * r * e.deltaK))));
    for (c = 0; c < h; ++c)
      (e = u[c]).model.skip ||
        ...
        d &&
          !d.model.skip &&
          ((s = (e.model.x - d.model.x) / 3),
          (e.model.controlPointPreviousX = e.model.x - s),
          (e.model.controlPointPreviousY = e.model.y - s * e.mK)),
        n &&
          !n.model.skip &&
          ((s = (n.model.x - e.model.x) / 3),
          (e.model.controlPointNextX = e.model.x + s),
          (e.model.controlPointNextY = e.model.y + s * e.mK)));
  }),
  ...
  (W.getRelativePosition = function (t, e) {
    ...
    return {
      x: (n = Math.round(
        (((n - r.left - l) / c) * a.width) / e.currentDevicePixelRatio
      )),
      y: (s = Math.round(
        (((s - r.top - d) / f) * a.height) / e.currentDevicePixelRatio
      )),
    };
  }),
  ...
  (W._calculatePadding = function (t, e, n) {
    return -1 < (e = W.getStyle(t, e)).indexOf("%")
      ? (n * parseInt(e, 10)) / 100
      : parseInt(e, 10);
  }),
  ...
  (W.getMaximumWidth = function (t) {
    ...
    var n = e.clientWidth,
      i =
        n -
        W._calculatePadding(e, "padding-left", n) -
        W._calculatePadding(e, "padding-right", n),
  ...
  (W.getMaximumHeight = function (t) {
    ...
    var n = e.clientHeight,
      i =
        n -
        W._calculatePadding(e, "padding-top", n) -
        W._calculatePadding(e, "padding-bottom", n),
  ...
  (W.retinaScale = function (t, e) {
    ...
    1 !== r &&
      ...
      n.style.height ||
        n.style.width ||
        ((n.style.height = i + "px"), (n.style.width = a + "px")));
  }),
  ...
  (W.measureText = function (t, e, n, i, a) {
    var r = e[a];
    return (
      r || ((r = e[a] = t.measureText(a).width), n.push(a)), i < r && (i = r), i
    );
  }),
  ...
  (W.getHoverColor = function (t) {
    return t instanceof CanvasPattern || t instanceof CanvasGradient
      ? t
      : W.color(t).saturate(0.5).darken(0.1).rgbString();
  }),
  (We._adapters = je),
  (We.Animation = X),
  (We.animationService = K),
  (We.controllers = jt),
  (We.DatasetController = tt),
  (We.defaults = N),
  (We.Element = Y),
  (We.elements = vt),
  (We.Interaction = Zt),
  ...
  (We.Ticks = qe),
  (We.Tooltip = Fe),
  We.helpers.each(Wn, function (t, e) {
  ...
  var ui = We;
  return (
    "undefined" != typeof window && (window.Chart = We),
    ((We.Chart = We).Legend = ni.legend._element),
    (We.Title = ni.title._element),
    (We.pluginService = We.plugins),
    (We.PluginBase = We.Element.extend({})),
    (We.canvasHelpers = We.helpers.canvas),
    (We.layoutService = We.layouts),
    (We.LinearScaleBase = ln),
    We.helpers.each(
