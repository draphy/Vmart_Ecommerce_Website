!(function (t, e) {
  ...
  function X(t, e) {
    var i = t.element.classList,
      l = W.state.scrolling(e);
    i.contains(l) ? clearTimeout(r[e]) : i.add(l);
  }
  function w(t, e) {
  ...
  function t(t, e, i, l, r) {
    ...
    !(function (t, e, i, l, r) {
      ...
      (t.reach[a] = null),
        ...
        e &&
          (u.dispatchEvent(f("ps-scroll-" + a)),
          e < 0
            ? u.dispatchEvent(f("ps-scroll-" + c))
            : 0 < e && u.dispatchEvent(f("ps-scroll-" + h)),
          l &&
            (function (t, e) {
              X(t, e), w(t, e);
            })(t, a)),
        t.reach[a] &&
          (e || r) &&
          u.dispatchEvent(f("ps-" + a + "-reach-" + t.reach[a]));
    })(t, i, n, l, r);
  }
  function b(t) {
  ...
  function h(t, e) {
    ...
    for (var n in ((this.element = t).classList.add(W.main),
    (this.settings = {
    ...
    (this.containerWidth = null),
      ...
      (this.scrollbarXRail = p(W.element.rail("x"))),
      t.appendChild(this.scrollbarXRail),
      (this.scrollbarX = p(W.element.thumb("x"))),
    ...
    (this.scrollbarXBottom = parseInt(a.bottom, 10)),
      ...
      (this.scrollbarYRail = p(W.element.rail("y"))),
      t.appendChild(this.scrollbarYRail),
      (this.scrollbarY = p(W.element.thumb("y"))),
    ...
    var c,
      h,
      u = Y(this.scrollbarYRail);
    (this.scrollbarYRight = parseInt(u.right, 10)),
      isNaN(this.scrollbarYRight)
        ? ((this.isScrollbarYUsingRight = !1),
          (this.scrollbarYLeft = b(u.left)))
      ...
      (this.scrollbarYOuterWidth = this.isRtl
        ? ((c = this.scrollbarY),
          b((h = Y(c)).width) +
            ...
            b(h.paddingRight) +
            b(h.borderLeftWidth) +
            b(h.borderRightWidth))
        : null),
      (this.railBorderYWidth = b(u.borderTopWidth) + b(u.borderBottomWidth)),
      d(this.scrollbarYRail, { display: "block" }),
      (this.railYMarginHeight = b(u.marginTop) + b(u.marginBottom)),
      ...
      (this.lastScrollTop = m(t.scrollTop)),
      ...
      wheel: function (b) {
        function t(t) {
          var e,
            ...
            f = d[1];
          !(function (t, e, i) {
            if (!L.isWebKit && g.querySelector("select:focus")) return 1;
            if (g.contains(t))
              for (var l = t; l && l !== g; ) {
                ...
                if (e && r.overflowX.match(/(scroll|auto)/)) {
                  ...
                  if (
                    0 < o &&
                    ((0 < l.scrollLeft && e < 0) || (l.scrollLeft < o && 0 < e))
                  )
                    return 1;
                }
                l = l.parentNode;
            ...
            b.settings.useBothWheelAxes
              ? b.scrollbarYActive && !b.scrollbarXActive
                ? (f
                    ? (g.scrollTop -= f * b.settings.wheelSpeed)
                    : (g.scrollTop += p * b.settings.wheelSpeed),
                  (r = !0))
                : b.scrollbarXActive &&
                  !b.scrollbarYActive &&
                  (p
                    ? (g.scrollLeft += p * b.settings.wheelSpeed)
                    : (g.scrollLeft -= f * b.settings.wheelSpeed),
                  (r = !0))
              : ((g.scrollTop -= f * b.settings.wheelSpeed),
                (g.scrollLeft += p * b.settings.wheelSpeed)),
            y(b),
            (r =
              ...
              (s = m(g.scrollTop)),
              (a = 0 === g.scrollTop),
              (c = s + g.offsetHeight === g.scrollHeight),
              (h = 0 === g.scrollLeft),
              (u = g.scrollLeft + g.offsetWidth === g.scrollWidth),
              !(v(o) > v(n) ? a || c : h || u) ||
              ...
              (function (t, e) {
                ...
                if (r < n) {
                  if (
                    ...
                    return 0 === window.scrollY && 0 < e && L.isChrome;
                } else if (
                  n < r &&
          ...
          s.settings.swipeEasing &&
            ...
            (l = setInterval(function () {
              return s.isInitialized ||
                (!f.x && !f.y) ||
                (v(f.x) < 0.01 && v(f.y) < 0.01)
                ? void clearInterval(l)
                : (a(30 * f.x, 30 * f.y), (f.x *= 0.8), void (f.y *= 0.8));
            }, 10)));
        }
        var u, d, p, f, l;
        (L.supportsTouch || L.supportsIePointer) &&
          ((u = s.element),
          (d = {}),
          (p = 0),
          (f = {}),
          (l = null),
          L.supportsTouch
            ? (s.event.bind(u, "touchstart", t),
              s.event.bind(u, "touchmove", e),
              s.event.bind(u, "touchend", i))
            : L.supportsIePointer &&
              (window.PointerEvent
                ? (s.event.bind(u, "pointerdown", t),
                  s.event.bind(u, "pointermove", e),
                  s.event.bind(u, "pointerup", i))
                : window.MSPointerEvent &&
                  (s.event.bind(u, "MSPointerDown", t),
                  s.event.bind(u, "MSPointerMove", e),
                  s.event.bind(u, "MSPointerUp", i))));
      },
    };
  return (
    (h.prototype.update = function () {
      this.isAlive &&
        ...
        (this.railXMarginWidth =
          b(Y(this.scrollbarXRail).marginLeft) +
          b(Y(this.scrollbarXRail).marginRight)),
        (this.railYMarginHeight =
          b(Y(this.scrollbarYRail).marginTop) +
          b(Y(this.scrollbarYRail).marginBottom)),
    ...
    (h.prototype.onScroll = function () {
      this.isAlive &&
        ...
        (this.lastScrollTop = m(this.element.scrollTop)),
