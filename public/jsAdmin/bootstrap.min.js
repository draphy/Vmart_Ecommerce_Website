!(function (t, e) {
    ...
    T =
      ...
      (_._addTouchEventListeners = function () {
        ...
        this._touchSupported &&
          ((t = function (t) {
            n._pointerEvent && w[t.originalEvent.pointerType.toUpperCase()]
      ...
      (C._jQueryInterface = function (i) {
        return this.each(function () {
          ...
          if (
            (t || ((t = new C(this, e)), g(this).data("bs.carousel", t)),
            "number" == typeof i)
          )
            t.to(i);
      ...
      (S.show = function () {
        ...
        this._isTransitioning ||
          ...
          n.isDefaultPrevented() ||
            (t &&
              (O._jQueryInterface.call(g(t).not(this._selector), "hide"),
          ...
          if ((g(this._element).trigger(e), !e.isDefaultPrevented())) {
            ...
            if (0 < i)
              for (var o = 0; o < i; o++) {
                ...
                null !== r &&
                  (g([].slice.call(document.querySelectorAll(r))).hasClass(
                    "show"
                  ) ||
                    g(s).addClass("collapsed").attr("aria-expanded", !1));
              }
  ...
  var j,
    ...
    F =
      ...
      (j._getConfig = function (t) {
        return (
          (t = r(
            r(r({}, this.constructor.Default), g(this._element).data()),
            t
          )),
              ...
              a &&
                ...
                !g(r).hasClass("show") ||
                  ...
                  s.isDefaultPrevented() ||
                    ...
                    g(r)
                      .removeClass("show")
                      .trigger(g.Event("hidden.bs.dropdown", l)))));
          }
      }),
        ...
        if (
          ...
          if (n || 27 !== t.which) {
            if (
              ...
              return (
                27 === t.which &&
                  g(e.querySelector('[data-toggle="dropdown"]')).trigger(
                    "focus"
                  ),
  ...
  g(document)
    ...
    .on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", F._clearMenus)
  ...
  var B,
    ...
    W =
      ...
      (B.show = function (t) {
        ...
        this._isShown ||
          this._isTransitioning ||
          (g(this._element).hasClass("fade") && (this._isTransitioning = !0),
      ...
      (B._showElement = function (t) {
        ...
        n
          ? ((s = m.getTransitionDurationFromElement(this._dialog)),
            g(this._dialog).one(m.TRANSITION_END, o).emulateTransitionEnd(s))
          : o();
      }),
      ...
      (B._setEscapeEvent = function () {
        var e = this;
        this._isShown
          ? g(this._element).on("keydown.dismiss.bs.modal", function (t) {
      ...
      (V._jQueryInterface = function (n, i) {
        return this.each(function () {
          ...
          if (
            (t || ((t = new V(this, e)), g(this).data("bs.modal", t)),
            "string" == typeof n)
          ) {
            if (void 0 === t[n])
              throw new TypeError('No method named "' + n + '"');
        ...
        i.forEach(function (t) {
          !(function (t, e) {
            ...
            if (-1 !== e.indexOf(n))
              return (
                -1 === z.indexOf(n) ||
                Boolean(t.nodeValue.match(K) || t.nodeValue.match(X))
              );
            for (
    ...
    st =
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          g(this.tip).hasClass("fade")
            ? ((c = m.getTransitionDurationFromElement(this.tip)),
              g(this.tip).one(m.TRANSITION_END, h).emulateTransitionEnd(c))
            : h();
        }
      }),
      ($.hide = function (t) {
          ...
          s.isDefaultPrevented() ||
            ...
            g(this.tip).hasClass("fade")
              ? ((n = m.getTransitionDurationFromElement(o)),
                g(o).one(m.TRANSITION_END, e).emulateTransitionEnd(n))
              : e(),
            (this._hoverState = ""));
      }),
      ($.update = function () {
        ...
        "object" != typeof e || (!e.nodeType && !e.jquery)
          ? this.config.html
            ? (this.config.sanitize &&
                (e = Y(e, this.config.whiteList, this.config.sanitizeFn)),
              t.html(e))
            : t.text(e)
          : this.config.html
      ...
      ($._enter = function (t, e) {
        ...
        (e = e || g(t.currentTarget).data(n)) ||
          ...
          g(e.getTipElement()).hasClass("show") || "show" === e._hoverState
            ? (e._hoverState = "show")
      ...
      (rt._jQueryInterface = function (n) {
        return this.each(function () {
          ...
          if (
            ...
            (t || ((t = new rt(this, e)), g(this).data("bs.tooltip", t)),
            "string" == typeof n)
          ) {
            if (void 0 === t[n])
              throw new TypeError('No method named "' + n + '"');
  ...
  var at = "popover",
    ...
    ut = r(r({}, st.DefaultType), {}, { content: "(string|element|function)" }),
    dt = {
      ...
      return (
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(n)) &&
              (t || ((t = new i(this, e)), g(this).data("bs.popover", t)),
              "string" == typeof n)
            ) {
              if (void 0 === t[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  var gt,
    ...
    bt =
      ...
      (gt._getConfig = function (t) {
        ...
        return (
          "string" !=
            typeof (t = r(r({}, _t), "object" == typeof t && t ? t : {}))
              .target &&
    ...
    Tt =
      (((Et = Ct.prototype).show = function () {
        ...
        (this._element.parentNode &&
          ...
          (s = g.Event("hide.bs.tab", { relatedTarget: this._element })),
    ...
    At =
      ...
      (St._close = function () {
        ...
        this._element.classList.remove("show"),
          this._config.animation
            ? ((e = m.getTransitionDurationFromElement(this._element)),
              g(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(e))
            : t();
      }),
