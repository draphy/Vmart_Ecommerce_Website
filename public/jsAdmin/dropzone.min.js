                  ...
                  (function (e) {
                    if (e.dataTransfer.types)
                      for (var t = 0; t < e.dataTransfer.types.length; t++)
                        if ("Files" === e.dataTransfer.types[t]) return 1;
                  })(e) &&
                  (e.stopPropagation(),
                ...
                if (
                  ...
                  var i = function () {
                    ...
                    i >= r.upload.totalChunkCount ||
                      ...
                      (t = Math.min(e + u.options.chunkSize, r.size)),
                      (n = {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (this.options.params) {
                ...
                for (var v in ("function" == typeof m &&
                  (m = m.call(
                    this,
                    t,
                    i,
    ...
    return (
      _createClass(e, null, [
        ...
        },
        {
          ...
          value: function (e) {
            for (
              var t, n, i, r, o = "", a = "", l = void 0, s = "", u = 0;
              (i = (t = e[u++]) >> 2),
                (r = ((3 & t) << 4) | ((n = e[u++]) >> 4)),
                (l = ((15 & n) << 2) | ((a = e[u++]) >> 6)),
                (s = 63 & a),
                isNaN(n) ? (l = s = 64) : isNaN(a) && (s = 64),
                (o =
                  o +
          ...
          value: function (e) {
            ...
            for (
              ...
              (t =
                ...
                ((n = this.KEY_STR.indexOf(e.charAt(l++))) >> 4)),
                (o =
                  ((15 & n) << 4) |
                  ((i = this.KEY_STR.indexOf(e.charAt(l++))) >> 2)),
                (a =
                  ((3 & i) << 6) | (r = this.KEY_STR.indexOf(e.charAt(l++)))),
                s.push(t),
                64 !== i && s.push(o),
                64 !== r && s.push(a),
                (o = a = ""),
