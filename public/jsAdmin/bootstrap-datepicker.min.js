!(function (t) {
  ...
  function t(t, e) {
    return function () {
      return (
        e !== V && x.fn.datepicker.deprecated(e), this[t].apply(this, arguments)
      );
    };
  }
  function k(t, e) {
  ...
  var e,
    i =
      ((e = {
        ...
        replace: function (t) {
          t &&
            (x.isArray(t) || (t = [t]), this.clear(), this.push.apply(this, t));
        },
        clear: function () {
          this.length = 0;
        },
  ...
  k.prototype = {
    ...
    _resolveViewName: function (i) {
      return (
        x.each(N.viewModes, function (t, e) {
    ...
    _check_template: function (t) {
      try {
        return t === V || "" === t
          ? !1
          : (t.match(/[<>]/g) || []).length <= 0 || 0 < x(t).length;
      } catch (t) {
        return !1;
      }
    },
    _process_options: function (t) {
      ...
      var e = (this.o = x.extend({}, this._o)),
        i = e.language;
      A[i] || ((i = i.split("-")[0]), A[i] || (i = d.language)),
        (e.language = i),
      ...
      var s,
        n,
        o,
        r = String(e.orientation).toLowerCase().split(/\s+/g),
        h = e.orientation.toLowerCase(),
        r = x.grep(r, function (t) {
          return /^auto|left|right|top|bottom$/.test(t);
        });
      if (((e.orientation = { x: "auto", y: "auto" }), h && "auto" !== h))
        if (1 === r.length)
          switch (r[0]) {
            case "top":
            case "bottom":
      ...
      e.defaultViewDate instanceof Date || "string" == typeof e.defaultViewDate
        ? (e.defaultViewDate = N.parseDate(
            e.defaultViewDate,
            a,
            e.language,
            e.assumeNearbyYear
        ...
        : e.defaultViewDate
        ? ((s = e.defaultViewDate.year || new Date().getFullYear()),
          (n = e.defaultViewDate.month || 0),
          (o = e.defaultViewDate.day || 1),
          (e.defaultViewDate = S(s, n, o)))
        : (e.defaultViewDate = F());
    },
    ...
    _buildEvents: function () {
      var t = {
        keyup: x.proxy(function (t) {
          -1 === x.inArray(t.keyCode, [27, 37, 39, 38, 40, 32, 13, 9]) &&
            this.update();
        }, this),
    ...
    paste: function (t) {
      ...
      if (
        ...
        -1 !== x.inArray("text/plain", t.originalEvent.clipboardData.types)
      )
    ...
    place: function () {
      ...
      var t = this.picker.outerWidth(),
        ...
        a = i.width(),
        s =
          "body" === this.o.container ? x(document).scrollTop() : i.scrollTop(),
        n = i.offset(),
        o = [0];
      ...
      "body" !== this.o.container && (u += s),
        ...
        "auto" !== this.o.orientation.x
          ...
          : h.left < 0
          ? (this.picker.addClass("datepicker-orient-left"), (c -= h.left - 10))
          : a < c + t
      ...
      return (
        ...
        this.o.rtl
          ? ((p = a - (c + d)),
            this.picker.css({ top: u, right: p, zIndex: r }))
    ...
    fillDow: function () {
      if (this.o.showWeekDays) {
        ...
        for (
          ...
          (e += '<th class="dow'),
            -1 !== x.inArray(t, this.o.daysOfWeekDisabled) &&
              (e += " disabled"),
    ...
    fillMonths: function () {
      for (
        ...
        e +=
          ...
          '">' +
          A[this.o.language].monthsShort[i] +
          "</span>";
      this.picker.find(".datepicker-months td").html(e);
    },
    setRange: function (t) {
      t && t.length
        ? (this.range = x.map(t, function (t) {
            return t.valueOf();
          }))
        : delete this.range,
        this.fill();
    ...
    getClassNames: function (t) {
      ...
      return (
        ...
        -1 !== x.inArray(t.getUTCDay(), this.o.daysOfWeekHighlighted) &&
          e.push("highlighted"),
        this.range &&
          (t > this.range[0] &&
    ...
    fill: function () {
      ...
      if (!isNaN(s) && !isNaN(a)) {
        this.picker
          ...
          .text(N.formatDate(i, c, this.o.language)),
          this.picker
            .find("tfoot .today")
            .text(l)
        ...
        for (var m, y, v, w, k, b, _ = []; f.valueOf() < D; ) {
          (m = f.getUTCDay()) === this.o.weekStart &&
            (_.push("<tr>"), this.o.calendarWeeks) &&
            ((v = new Date(+f + ((this.o.weekStart - m - 7) % 7) * 864e5)),
            (w = new Date(Number(v) + ((11 - v.getUTCDay()) % 7) * 864e5)),
            (k = new Date(
              Number((k = S(w.getUTCFullYear(), 0, 1))) +
                ((11 - k.getUTCDay()) % 7) * 864e5
            )),
            (b = (w - k) / 864e5 / 7 + 1),
            _.push('<td class="cw">' + b + "</td>")),
            (y = this.getClassNames(f)).push("day");
          var C = f.getUTCDate();
          this.o.beforeShowDay !== x.noop &&
            ((e = this.o.beforeShowDay(this._utc_to_local(f))) === V
              ? (e = {})
              : "boolean" == typeof e
              ? (e = { enabled: e })
            ...
            (y = x.isFunction(x.uniqueSort) ? x.uniqueSort(y) : x.unique(y)),
            _.push(
              '<td class="' +
                y.join(" ") +
                '"' +
            ...
            (t = null),
            m === this.o.weekEnd && _.push("</tr>"),
            f.setUTCDate(f.getUTCDate() + 1);
        }
        this.picker.find(".datepicker-days tbody").html(_.join(""));
        var T,
          M = A[this.o.language].monthsTitle || A.en.monthsTitle || "Months",
          U = this.picker
            .find(".datepicker-months")
            .find(".datepicker-switch")
            .text(this.o.maxViewMode < 2 ? M : s)
            .end()
            .find("tbody span")
            .removeClass("active");
          ...
          this.o.beforeShowMonth !== x.noop &&
            ...
            x.each(U, function (t, e) {
              ...
              a === V
                ...
                !1 !== a.enabled ||
                  x(e).hasClass("disabled") ||
                  x(e).addClass("disabled"),
    ...
    click: function (t) {
      ...
      t.preventDefault(),
        t.stopPropagation(),
        (e = x(t.target)).hasClass("datepicker-switch") &&
    ...
    dateIsDisabled: function (e) {
      return (
        ...
        0 <
          x.grep(this.o.datesDisabled, function (t) {
            return n(e, t);
          }).length
      );
    },
    ...
    setViewMode: function (t) {
      (this.viewMode = t),
        this.picker
          .children("div")
          .hide()
          .filter(".datepicker-" + N.viewModes[this.viewMode].clsName)
          .show(),
        this.updateNavArrows(),
  ...
  function l(t, e) {
    x.data(t, "datepicker", this),
      ...
      s
        .call(x(this.inputs), e)
        .on("changeDate", x.proxy(this.dateUpdated, this)),
        ...
        this.each(function () {
          ...
          s ||
            ((t = (function (t, e) {
              ...
              for (var o in ((e = new RegExp("^" + e.toLowerCase())), a))
                e.test(o) && (s[o.replace(n, i)] = a[o]);
              return s;
            })(this, "date")),
            (e = (function (t) {
              var i = {};
            ...
            (i = x.extend({}, d, e, t, n)),
            (s =
              a.hasClass("input-daterange") || i.inputs
                ? (x.extend(i, {
  ...
  var A = (x.fn.datepicker.dates = {
    ...
    N = {
      ...
      parseDate: function (t, e, i, s) {
        function a() {
          var t = this.slice(0, n[v].length),
            e = n[v].slice(0, t.length);
          return t.toLowerCase() === e.toLowerCase();
        }
        if (!t) return V;
        if (t instanceof Date) return t;
        if (("string" == typeof e && (e = N.parseFormat(e)), e.toValue))
        ...
        if (
          ...
          for (
            n = t.match(/([\-+]\d+)([dmwy])/gi), t = new Date(), v = 0;
            v < n.length;
            v++
          )
            (o = n[v].match(/([\-+]\d+)([dmwy])/i)),
              (r = Number(o[1])),
              (h = l[o[2].toLowerCase()]),
              (t = k.prototype[h](t, r));
        ...
        if (
          ...
          for (var m, y, v = 0, w = D.length; v < w; v++) {
            if (((c = parseInt(n[v], 10)), (o = D[v]), isNaN(c)))
              switch (o) {
                case "MM":
                  (u = x(A[i].months).filter(a)),
                    (c = x.inArray(u[0], A[i].months) + 1);
                  break;
                case "M":
                  (u = x(A[i].monthsShort).filter(a)),
                    (c = x.inArray(u[0], A[i].monthsShort) + 1);
              }
            p[o] = c;
          }
          for (v = 0; v < f.length; v++)
            (y = f[v]) in p &&
              !isNaN(p[y]) &&
              ((m = new Date(t)), g[y](m, p[y]), isNaN(m) || (t = m));
        }
        return t;
      },
      formatDate: function (t, e, i) {
        if (!t) return "";
        if (("string" == typeof e && (e = N.parseFormat(e)), e.toDisplay))
        ...
        (a.dd = (a.d < 10 ? "0" : "") + a.d),
          ...
          (t = []);
        for (
          var s = x.extend([], e.separators), n = 0, o = e.parts.length;
          n <= o;
          n++
        )
