!(function (S, z, N) {
  ...
  (t = function (L) {
    ...
    (L.SPFormatClass = m =
      ...
      (B = function (t) {
        for (var e = [], i = t.length; i--; ) e[i] = F(t[i]);
        return e;
      }),
      (O = function (t, e) {
      ...
      (L.fn.sparkline = function (l, i) {
        return this.each(function () {
          var t,
            ...
            e = function () {
              var t,
                ...
                n =
                  "html" === l || l === N
                    ? (((r = this.getAttribute(h.get("tagValuesAttribute"))) !==
                        N &&
                        null !== r) ||
                        (r = o.html()),
              ...
              "auto" === h.get("height")
                ? (h.get("composite") && L.data(this, "_jqs_vcanvas")) ||
                  (((e = S.createElement("span")).innerHTML = "a"),
                  o.html(e),
                  (t = L(e).innerHeight() || L(e).height()),
                  L(e).remove(),
                  (e = null))
                : (t = h.get("height")),
                h.get("disableInteraction")
                  ? (i = !1)
                  : (i = L.data(this, "_jqs_mhandler"))
                  ? h.get("composite") || i.reset()
                  : ((i = new u(this, h)), L.data(this, "_jqs_mhandler", i)),
                !h.get("composite") || L.data(this, "_jqs_vcanvas")
                  ? ((s = new L.fn.sparkline[h.get("type")](
                      this,
                      n,
                      h,
                      a,
          ...
          if (
            ...
            f.push([this, e]), L.data(this, "_jqs_pending", !0);
          } else e.call(this);
        });
      }),
        ...
        for (var t, e = [], i = 0, s = f.length; i < s; i++)
          (t = f[i][0]),
            L(t).is(":visible") && !L(t).parents().is(":hidden")
              ? (f[i][1].call(t),
                L.data(f[i][0], "_jqs_pending", !1),
                e.push(i))
              : L(t).closest("html").length ||
                L.data(t, "_jqs_pending") ||
                (L.data(f[i][0], "_jqs_pending", !1), e.push(i));
        for (i = e.length; i; i--) f.splice(e[i - 1], 1);
      }),
      (L.fn.sparkline.options = R({
        ...
        getTagSetting: function (t) {
          ...
          if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
            ...
            if ((e = this.tag.getAttribute(n + t)) === N || null === e) e = v;
        ...
        R(L.fn.sparkline._base, {
          ...
          getRegion: function (t, e, i) {
            for (var s = this.regionMap, r = s.length; r--; )
              if (null !== s[r] && e >= s[r][0] && e <= s[r][1]) return s[r][2];
            return N;
          },
          getCurrentRegionFields: function () {
        ...
        R(L.fn.sparkline._base, i, {
          ...
          init: function (t, e, i, s, r) {
            var n,
              ...
              T = -1 / 0;
            for (
              X._super.init.call(this, t, e, i, s, r), j = 0, P = e.length;
              j < P;
              j++
            )
              ((n = "string" == typeof (b = e[j]) && -1 < b.indexOf(":")) ||
                L.isArray(b)) &&
                ((m = !0),
                n && (b = e[j] = B(b.split(":"))),
                (b = O(b, null)),
                (a = z.min.apply(z, b)) < W && (W = a),
                T < (h = z.max.apply(z, b)) && (T = h));
            (this.stacked = m),
              (this.regionShapes = {}),
              (this.barWidth = S),
              (this.barSpacing = k),
            ...
            (this.max = d = z.max.apply(z, l)),
              ...
              i.get("chartRangeMin") !== N &&
                (i.get("chartRangeClip") || i.get("chartRangeMin") < c) &&
                (c = i.get("chartRangeMin")),
              i.get("chartRangeMax") !== N &&
                (i.get("chartRangeClip") || i.get("chartRangeMax") > d) &&
                (d = i.get("chartRangeMax")),
              (this.zeroAxis = p = i.get("zeroAxis", !0)),
              (u = c <= 0 && 0 <= d && p ? 0 : 0 == p || 0 < c ? c : d),
              (this.xaxisOffset = u),
              (g = m ? z.max.apply(z, o) + z.max.apply(z, I) : d - c),
              (this.canvasHeightEf =
                p && c < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
              c < u
                ? (R =
                    (((m && 0 <= d ? T : d) - u) / g) * this.canvasHeight) !==
                    z.ceil(R) && ((this.canvasHeightEf -= 2), (R = z.ceil(R)))
                : (R = this.canvasHeight),
              (this.yoffset = R),
          ...
          calcColor: function (t, e, i) {
            var s,
              ...
              h = this.stacked
                ...
                : a.get("barColor");
            return (
              0 === e && a.get("zeroColor") !== N && (h = a.get("zeroColor")),
              n && (s = n.get(e)) ? (h = s) : r && r.length > i && (h = r[i]),
              L.isArray(h) ? h[t % h.length] : h
            );
          },
          renderRegion: function (t, e) {
            var i,
              ...
              w = b(g, o, !0);
            if (C)
              return l.get("nullColor")
                ? ((r = e
                    ? l.get("nullColor")
                    : this.calcHighlightColor(l.get("nullColor"), l)),
                  (i = 0 < m ? m - 1 : m),
                  d.drawRect(f, i, this.barWidth - 1, 0, r, r))
                : N;
            for (n = m, a = 0; a < x; a++) {
              if (((y = o[a]), c && y === g)) {
                if (!w || h) continue;
      ...
      (L.fn.sparkline.tristate = h =
        R(L.fn.sparkline._base, i, {
          ...
          renderRegion: function (t, e) {
            ...
            if (null !== g)
              return (
                e && (g = this.calcHighlightColor(g, r)),
                n.drawRect(o, i, this.barWidth - 1, l - 1, g, g)
              );
          },
        })),
        ...
        R(L.fn.sparkline._base, i, {
          ...
          renderRegion: function (t, e) {
            var i = this.values,
              ...
              d = z.round(p - ((u - r) / a) * p),
              f =
                s.get("thresholdColor") && u < s.get("thresholdValue")
                  ? s.get("thresholdColor")
                  : s.get("lineColor");
            return (
              e && (f = this.calcHighlightColor(f, s)),
              o.drawLine(c, d, c, d + g, f)
            );
          },
        })),
          ...
          renderSlice: function (t, e) {
            for (
              ...
              if (((s = i = c), 0 < u && (s = c + g * (p[f] / u)), t === f))
                return (
                  (r = a.get("sliceColors")[f % a.get("sliceColors").length]),
                  e && (r = this.calcHighlightColor(r, a)),
                  n.drawPieSlice(h, h, h - o, i, s, N, r)
                );
              c = s;
            }
          },
      ...
      (c = R(r, {
        ...
        replaceWithShapes: function (t, e) {
          ...
          for (a = e.length; a--; )
            r.splice(s, 0, e[a].id), (this.shapes[e[a].id] = e[a]);
        },
        insertAfterShape: function (t, e) {
      ...
      (d = R(r, {
        ...
        replaceWithShapes: function (t, e) {
          for (
            var i = L("#jqsshape" + t[0]), s = "", r = e.length, n = 0;
            n < r;
            n++
          )
