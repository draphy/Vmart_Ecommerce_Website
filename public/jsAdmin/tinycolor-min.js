!(function (u) {
        ...
        "object" == typeof r &&
          (R(r.r) && R(r.g) && R(r.b)
            ? ((n = (function (t, e, r) {
              ...
              (f = !0),
              (h = "%" === String(r.r).substr(-1) ? "prgb" : "rgb"))
            : R(r.h) && R(r.s) && R(r.v)
            ? ((i = w(r.s)),
              (s = w(r.v)),
              (n = (function (t, e, r) {
              ...
              (n = (function (t, e, r) {
                ...
                return (
                  ...
                  0 === e
                    ...
                    : ((a = n(
                        (f =
                          2 * r - (o = r < 0.5 ? r * (1 + e) : r + e - r * e)),
                        o,
                        t + 1 / 3
                      )),
                      (i = n(f, o, t)),
                      (s = n(f, o, t - 1 / 3))),
                  { r: 255 * a, g: 255 * i, b: 255 * s }
                );
              })(r.h, i, o)),
              (f = !0),
              (h = "hsl")),
  ...
  function f(t, e) {
    ...
    var r = c(t).toRgb();
    return (
      (r.r = L(0, I(255, r.r - M((-e / 100) * 255)))),
      (r.g = L(0, I(255, r.g - M((-e / 100) * 255)))),
      (r.b = L(0, I(255, r.b - M((-e / 100) * 255)))),
      c(r)
    );
  }
  function h(t, e) {
  ...
  function b(t) {
    ...
    return [
      c(t),
      c({ h: (r + 120) % 360, s: e.s, l: e.l }),
      c({ h: (r + 240) % 360, s: e.s, l: e.l }),
    ];
  }
  function d(t) {
    var e = c(t).toHsl(),
    ...
    return [
      c(t),
      c({ h: (r + 90) % 360, s: e.s, l: e.l }),
      c({ h: (r + 180) % 360, s: e.s, l: e.l }),
  ...
  function _(t) {
    ...
    return [
      c(t),
      c({ h: (r + 72) % 360, s: e.s, l: e.l }),
      c({ h: (r + 216) % 360, s: e.s, l: e.l }),
    ];
  }
  function p(t, e, r) {
    (e = e || 6), (r = r || 30);
  ...
  function m(t, e) {
    e = e || 6;
    for (
      var r = c(t).toHsv(), n = r.h, a = r.s, i = r.v, s = [], o = 1 / e;
      e--;
  ...
  function y(t, e) {
    ...
    return (
      (t = I(e, L(0, parseFloat(t)))),
      a && (t = parseInt(t * e, 10) / 100),
  ...
  (c.prototype = {
    ...
    getLuminance: function () {
      var t = this.toRgb(),
        ...
        n = t.b / 255;
      return (
        0.2126 * (e <= 0.03928 ? e / 12.92 : u.pow((0.055 + e) / 1.055, 2.4)) +
        0.7152 * (r <= 0.03928 ? r / 12.92 : u.pow((0.055 + r) / 1.055, 2.4)) +
        0.0722 * (n <= 0.03928 ? n / 12.92 : u.pow((0.055 + n) / 1.055, 2.4))
      );
    },
    setAlpha: function (t) {
    ...
    toRgbString: function () {
      return 1 == this._a
        ? "rgb(" + M(this._r) + ", " + M(this._g) + ", " + M(this._b) + ")"
        : "rgba(" +
            M(this._r) +
            ", " +
            M(this._g) +
    ...
    toName: function () {
      return 0 === this._a
        ? "transparent"
        : (!(this._a < 1) && O[e(this._r, this._g, this._b, !0)]) || !1;
    },
    toFilter: function (t) {
      var e,
    ...
    (c.readability = function (t, e) {
      var r = c(t),
        n = c(e);
      return (
        (u.max(r.getLuminance(), n.getLuminance()) + 0.05) /
        (u.min(r.getLuminance(), n.getLuminance()) + 0.05)
      );
    }),
    (c.isReadable = function (t, e, r) {
      ...
      switch (
        ("AA" !==
          (i = (
            (a = (a = r) || { level: "AA", size: "small" }).level || "AA"
          ).toUpperCase()) &&
          "AAA" !== i &&
          (i = "AA"),
    ...
    (c.mostReadable = function (t, e, r) {
      ...
      return c.isReadable(t, a, { level: o, size: f }) || !s
        ? a
        : ((r.includeFallbackColors = !1),
          c.mostReadable(t, ["#fff", "#000"], r));
    });
  var z,
    E,
    T,
