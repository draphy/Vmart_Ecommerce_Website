!(function (n) {
      ...
      e.define("select2/translation", ["jquery", "require"], function (t, n) {
        ...
        return (
          ...
          (r.loadPath = function (e) {
            var t;
            return (
              e in r._cache || ((t = n(e)), (r._cache[e] = t)),
              new r(r._cache[e])
            );
          }),
          r
            ...
            (r.prototype.convertToOptions = function (e) {
              for (
                ...
                0 <= f.inArray(p.id, r)
                  ...
                  : ((u = this.option(p)),
                    p.children &&
                      ((d = this.convertToOptions(p.children)),
                      h.appendMany(u, d)),
                    i.push(u));
              }
              return i;
        ...
        return (
          ...
          (e.prototype.query = function (e, t, n) {
            ...
            var i = this.tokenizer(t, this.options, function (e) {
              ...
              r.$element.find("option").filter(function () {
                ...
                ((t = r.option(n)).attr("data-select2-tag", !0),
                r._removeOldTags(),
                r.addOptions([t])),
          ...
          (e.prototype.tokenizer = function (e, t, n, r) {
            for (
              ...
              -1 !== d.inArray(u, i)
                ? ((l = o.substr(0, s)),
                  null != (c = a(d.extend({}, t, { term: l })))
                    ? (r(c), (o = o.substr(s + 1) || ""), (s = 0))
                    : s++)
                : s++;
            }
            return { term: o };
      ...
      e.define("select2/dropdown/selectOnClose", ["../utils"], function (o) {
        ...
        return (
          ...
          (e.prototype._handleSelectOnClose = function (e, t) {
            ...
            i.length < 1 ||
              (null != (r = o.GetData(i[0], "data")).element &&
                r.element.selected) ||
            ...
            (n.prototype.apply = function (e) {
              ...
              null == (e = c.extend(!0, {}, this.defaults, e)).dataAdapter &&
                ...
                null != e.initSelection &&
                  ((n = u(e.amdBase + "compat/initSelection")),
                ...
                null == e.dropdownAdapter &&
                  (e.multiple
                    ? (e.dropdownAdapter = E)
                    : ((r = y.Decorate(E, C)), (e.dropdownAdapter = r)),
                  ...
                  (null == e.dropdownCssClass &&
                    ...
                    ((i = u(e.amdBase + "compat/dropdownCss")),
  ...
  function x(e) {
    var t;
    if (
      (w(v, e) && ((t = v[e]), delete v[e], (_[e] = !0), o.apply(h, t)),
      !w(m, e) && !w(_, e))
    )
